...
public class CommonConst {
	...
	public static final String ROLE_MODE_BIND_ORG = "0";
	public static final String ROLE_MODE_UNBIND_ORG = "1";
	public static final String ROLE_MODE_BOTH = "2";

	// 用户信息维护 - 操作类型： 新增
	public static final String OPER_TYPE_ADD = "01";
	// 用户信息维护 - 操作类型： 修改
	public static final String OPER_TYPE_UPDATE = "02";
	// 用户信息维护 - 操作类型： 删除
	public static final String OPER_TYPE_DELETE = "03";

	// 用户状态：正常
	public static final String USER_STATUS_NORMAL = "01";

	// 登陆状态：未登陆
	public static final String LOGIN_STATUS_NOT_LOGIN = "01";
