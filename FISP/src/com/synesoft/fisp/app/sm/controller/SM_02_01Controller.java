...
public class SM_02_01Controller {
	private static final Logger logger = LoggerFactory
			.getLogger(SM_02_01Controller.class);
	...
	public String del(RoleInfForm form,
			BindingResult result, Model model) {
		logger.info("start del ...");
		if (result.hasErrors()) {
			return "forward:/sm02/01/search";
		}
		try {
			roleInfService.transDel(form);
