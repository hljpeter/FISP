<script type="text/javascript">
	...
	function modify() {
		...
		form.action = "${pageContext.request.contextPath}/al01/03/modify";
...
<!-- title -->
<div class="page_title">任务管理 / 警报配置 / <spring:message code="index.lable.SysAlertPrctModify"/></div>

<!-- body -->

<div class="row" style="margin-bottom: 20px;">
	<form:form id="form" action="${pageContext.request.contextPath}/al01/03/init" method="post"  traget="curWindow" modelAttribute="sysAlertRcptForm" class="form-horizontal">
	<form:input id="id" type="hidden" path="sysAlertRcpt.id"/>
