...
window.name="curWindow";
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/bp04/01/search";
	...
	function modify(id) {
		...
		window.showModalDialog('${pageContext.request.contextPath}/bp04/02/search?loanAmount.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	...
	function del(id) {
		...
		form.action = "${pageContext.request.contextPath}/bp04/01/del";
	...
	function detailSearch(id) {
		document.getElementById("loanAmountId").value = id;
		window.showModalDialog('${pageContext.request.contextPath}/bp04/03/detailSearch?loanAmount.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	}
	
	//add button
	function add() {
		window.showModalDialog('${pageContext.request.contextPath}/bp04/06/init', window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.processedListLoanAmountInputQuery"/></div>

<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/bp04/01/init" method="post" modelAttribute="loanAmountForm" class="form-horizontal">
