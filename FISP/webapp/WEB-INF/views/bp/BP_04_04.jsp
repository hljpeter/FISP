...
window.name="curWindow";
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/bp04/04/search";
	...
	function detailSearch(id) {
		...
		window.showModalDialog('${pageContext.request.contextPath}/bp04/05/detailSearch?loanAmount.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.processedListLoanAmountAuthQuery"/></div>

<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/bp04/04/init" method="post" modelAttribute="loanAmountForm" class="form-horizontal">
