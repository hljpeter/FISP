...
<script type="text/javascript">
	...
	function add() {
		...
		form.action = "${pageContext.request.contextPath}/bp04/06/add";
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.processedListLoanAmountAdd"/></div>
<!-- body -->
<div class="row" style="margin-bottom: 40px;">
	<form:form id="form" action="${pageContext.request.contextPath}/bp04/02/search" method="post" modelAttribute="loanAmountForm" class="form-horizontal">
