<script type="text/javascript">
	...
	function input() {
		...
		form.action = "${pageContext.request.contextPath}/bp05/06/add";
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.processedListDepositBalanceAdd"/></div>
<!-- body -->
<div class="row" style="margin-bottom: 40px;">
	<form:form id="form" action="${pageContext.request.contextPath}/bp05/06/init" method="post" modelAttribute="depositBalanceForm" class="form-horizontal">
		<table class="tbl_search">
			...
			<tr>
				...
				<td>
					<form:select id="customerType" path="depositBalance.customerType" >
						<form:option value=""/>
			...
			<tr>
				...
				<td colspan="3">
					<form:input path="depositBalance.customerName" type="text" class="input-xxlarge"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<form:input path="depositBalance.depositAgreementSdate" type="text" maxlength="8" class="Wdate .input-small"
					 onclick="WdatePicker({maxDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'});" />
				</td>
				<td class="label_td"><spring:message code="fisp.la.depositAgreementEdate"/></td>
				<td>
					<form:input path="depositBalance.depositAgreementEdate" type="text" maxlength="8" class="Wdate .input-small"
					 onclick="WdatePicker({maxDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'});" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<t:moneyFormat value="${depositBalanceForm.interestRate}" dot="true" type="text" name="interestRate"/>
				</td>
			</tr>
	    </table>											
	</form:form>
