<!-- title -->
<div class="page_title"><spring:message code="fisp.title.processedListDepositBalanceDetailQueryDetail"/></div>
<!-- body -->
<div class="row" style="margin-bottom: 40px;">
	<form:form id="form" action="${pageContext.request.contextPath}/bp05/03/detailSearch" method="post" modelAttribute="depositBalanceForm" class="form-horizontal">
