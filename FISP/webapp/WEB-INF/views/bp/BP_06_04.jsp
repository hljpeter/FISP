...
window.name="curWindow";
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/bp06/04/search";
	...
	function detailSearch(id) {
		...
		window.showModalDialog('${pageContext.request.contextPath}/bp06/05/detailSearch?loanBalance.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.processedListLoanBalanceAuthQuery"/></div>
	...
	<table class="table table-striped table-bordered table-condensed tbl_page">
      <thead>
        <tr>
            ...
            <th class="tbl_page_th" width="90px"><spring:message code="fisp.la.LoanIouBalance"/></th>
