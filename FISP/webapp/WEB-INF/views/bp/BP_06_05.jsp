...
<!--
	...
	function auth() {
		...
		form.action = "${pageContext.request.contextPath}/bp06/05/auth";
	...
	function authCancel() {
		var form = document.getElementById("detailSearchForm");
		form.action = "${pageContext.request.contextPath}/bp06/05/cancel";
	...
	function reject() {
		var form = document.getElementById("detailSearchForm");
		form.action = "${pageContext.request.contextPath}/bp06/05/reject";
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.processedListLoanBalanceAuthDetailQuery"/></div>
<!-- body -->
<div class="row" style="margin-bottom: 40px;">
	<form:form id="detailSearchForm" action="${pageContext.request.contextPath}/bp06/05/detailSearch" method="post" modelAttribute="loanBalanceForm" class="form-horizontal">
