<!-- title -->
<div class="page_title"><spring:message code="fisp.title.processedListLoanBalanceDetailQueryDetail"/></div>
<!-- body -->
<div class="row" style="margin-bottom: 40px;">
	<form:form id="form" action="${pageContext.request.contextPath}/bp06/03/detailSearch" method="post" modelAttribute="loanBalanceForm" class="form-horizontal">
