...
<!--
	...
	function auth() {
		...
		form.action = "${pageContext.request.contextPath}/dp01/05/auth";
	...
	function authCancel() {
		var form = document.getElementById("detailSearchForm");
		form.action = "${pageContext.request.contextPath}/dp01/05/cancel";
	...
	function reject() {
		var form = document.getElementById("detailSearchForm");
		form.action = "${pageContext.request.contextPath}/dp01/05/reject";
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.DataManageloanAmountAuthDetailQuery"/></div>
<!-- body -->
<div class="row" style="margin-bottom: 40px;">
	<form:form id="detailSearchForm" action="${pageContext.request.contextPath}/dp01/05/detailSearch" method="post" modelAttribute="loanAmountForm" class="form-horizontal">
