<script type="text/javascript">
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/dp02/01/search";
		form.submit();
	}
	//add button
	function add() {
		window.showModalDialog('${pageContext.request.contextPath}/dp02/06/init', window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	}
	//modify button
	function modify(id) {
		var old_url ="${pageContext.request.contextPath}/dp02/01/search";
		document.getElementById("depositBalanceId").value = id;
		window.showModalDialog('${pageContext.request.contextPath}/dp02/02/search?depositBalance.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	...
	function del(id) {
		...
		form.action = "${pageContext.request.contextPath}/dp02/01/del";
	...
	function detailSearch(id) {
		document.getElementById("depositBalanceId").value = id;
		window.showModalDialog('${pageContext.request.contextPath}/dp02/03/detailSearch?depositBalance.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	}
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.DataManageDepositBalanceInputQuery"/></div>
