<script type="text/javascript">
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/dp03/03/search";
		form.submit();
	}
	//detail button
	function detailSearch(id) {
		document.getElementById("loanBalanceId").value = id;
		window.showModalDialog('${pageContext.request.contextPath}/dp03/03/detailSearch?loanBalance.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	}
</script>
<!-- tips information -->
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.loanBalanceQuery"/></div>
