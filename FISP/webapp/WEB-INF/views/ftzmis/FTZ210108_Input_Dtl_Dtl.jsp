<script type="text/javascript">
	...
	function addDetail() {
		...
		var input_Dtl_flag = $("#input_Dtl_flag").val();
		if ('add' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210108/AddDtlDtlSubmit";
		} else if ('upt' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210108/UptDtlDtlSubmit";
		}
		form.submit();
	}
	...
	function addRef() {
		...
		form1.action = "${pageContext.request.contextPath}/FTZ210108/AddDtlDtlInit";
		form1.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210108.input.dtl.dtl" />
</div>
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td><t:moneyFormat type="text" id="amount"
						...
						value="${FTZ210108Form.ftzInTxnDtl.amount}"
...
<form:form id="form1" modelAttribute="FTZ210108Form" method="post">
