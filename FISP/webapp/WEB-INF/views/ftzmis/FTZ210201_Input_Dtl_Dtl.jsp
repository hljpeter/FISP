<script type="text/javascript">
	...
	function addDetail() {
		...
		var input_Dtl_flag = $("#input_Dtl_flag").val();
		if ('add' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210201/AddDtlDtlSubmit";
		} else if ('upt' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210201/UptDtlDtlSubmit";
		}
		form.submit();
	}
	...
	function addRef() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210201/AddDtlDtlInit";
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210201.input.dtl.dtl" />
</div>
	...
	<form:form id="form"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td>
					<form:input id="documentNo" path="ftzInTxnDtl.documentNo" type="text" class=".input-small"/>
				</td>
			</tr>
			<tr>
				<td class="label_td"><font color="red">* </font><spring:message code="ftz.label.LOAN_TYPE" />：</td>
				<td><form:select path="ftzInTxnDtl.loanType">
						<form:option value=""></form:option>
...
<form:form id="form1" modelAttribute="FTZ210201Form" method="post">
