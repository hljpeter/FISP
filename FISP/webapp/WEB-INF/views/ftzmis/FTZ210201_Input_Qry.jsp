<script type="text/javascript">
		...
		$("#pageTable")
				...
				.bind(
						...
						function() {
							...
							window
									.showModalDialog(
											'${pageContext.request.contextPath}/FTZ210201/QryDtl?selected_msgId='
													+ selected_msgId,
											window,
	...
	function addDetail() {
		window
				.showModalDialog(
						'${pageContext.request.contextPath}/FTZ210201/AddDtlInit',
						window,
						'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
		queryFTZ210201();
	}
	function uptDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			if ("01" == selected_msgType || "04" == selected_msgType|| "02" == selected_msgType) {
				window
						.showModalDialog(
								'${pageContext.request.contextPath}/FTZ210201/UptDtlInit?selected_msgId='
										+ selected_msgId,
								window,
								'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
				queryFTZ210201();
	...
	function queryFTZ210201() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210201/AddQry";
		form.submit();
	}
</script>
