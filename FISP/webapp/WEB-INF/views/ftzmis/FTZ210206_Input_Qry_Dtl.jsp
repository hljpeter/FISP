...
if (actionFlag == "addMsg") {
	...
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210206/Input/AddMsg/Sumbit");
	...
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210206/Input/UptMsg/Sumbit");
	//var success = '${successmsg}';
	//if (success && success != '') {
		//$("input[type=submit]").attr("disabled", true);
	//}
	...
	//var operFlag = '${FTZ210206Form.operFlag }';
	//if (operFlag == "updated") {
		//$("input[type=submit]").attr("disabled", true);
	//}
}
...
$("#add").click(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210206/Input/AddTxn/Init?ftzInTxnDtl.msgId=' 
...
$("#dtl").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		showDialog('${pageContext.request.contextPath}/FTZ210206/Input/DtlTxn/Init?ftzInTxnDtl.msgId=' 
...
$("#del").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#operFlag").val("updated");
			$("#balance").val($("#balance").val().replaceAll(",", ""));
			$("#form").attr("action", '${pageContext.request.contextPath}/FTZ210206/Input/DelTxn/Submit?ftzInTxnDtl.msgId=' 
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210206.input.dtl"/></div>
<!-- body -->
<div class="row">
