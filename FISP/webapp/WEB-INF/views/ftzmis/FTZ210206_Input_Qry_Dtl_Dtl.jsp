<!-- 6.3.3　应付保函/备用证（210206） / 录入新增 - 交易页面 -->
<script type="text/javascript">
$(function() {
var actionFlag = '${FTZ210206Form.actionFlag }';
if (actionFlag == "addTxn") {
	$(".dtl").css("display", "none");
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210206/Input/AddTxn/Submit");
	...
	$(".dtl").css("display", "none");
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210206/Input/UptTxn/Submit");
	var success = '${successmsg }';
	if (success && success != "") {
		$("input").attr("readonly", true);
		$("select").attr("disabled", true);
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210206.input.dtl.dtl"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}" method="post" modelAttribute="FTZ210206Form" class="form-horizontal">
		...
		<table class="tbl_search">
			...
			<tr class="dtl">	
				...
				<td colspan="3"><t:codeValue items="${FTZ_MSG_STATUS }" key="${FTZ210206Form.ftzInTxnDtl.chkStatus }" type="text"  cssClass="input-large" readonly="true"/></td>
			</tr>
			<tr class="dtl">	
				...
				<td><t:dateTimeFormat type="text" value="${FTZ210206Form.ftzInTxnDtl.makDatetime }" format="datetime" name="ftzInTxnDtl.makDatetime" cssClass="input-large" readonly="true"/></td>
			</tr>
			<tr class="dtl">	
				...
				<td><t:dateTimeFormat type="text" value="${FTZ210206Form.ftzInTxnDtl.chkDatetime }" format="datetime" name="ftzInTxnDtl.chkDatetime" cssClass="input-large" readonly="true"/></td>
			</tr>
			<tr class="dtl">	
