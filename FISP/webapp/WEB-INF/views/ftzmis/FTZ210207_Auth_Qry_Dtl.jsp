...
$("#dtl").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		showDialogAndRefresh('${pageContext.request.contextPath}/FTZ210207/Auth/DtlTxn/Init?ftzInTxnDtl.msgId=' 
				+ $("#msgId").val() + "&ftzInTxnDtl.seqNo=" + selectedRow.seqNo, '600', '1040');
		
		$("#balance").val($("#balance").val().replaceAll(",", ""));
		$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210207/Auth/DtlMsg/Init");
		$("#form").submit();
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" query="ftzInMsgCtl.msgId=${FTZ210207Form.ftzInMsgCtl.msgId }" />
		</div>
	</div>
</div>
