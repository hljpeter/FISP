...
$("#add").click(function() {
	...
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210207/Input/UptMsg/Init");
	$("#form").submit();
...
$("#dtl").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		showDialog('${pageContext.request.contextPath}/FTZ210207/Input/DtlTxn/Init?ftzInTxnDtl.msgId=' 
