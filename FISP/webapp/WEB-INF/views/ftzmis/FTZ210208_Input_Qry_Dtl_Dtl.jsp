...
<table class="tbl_search">
			...
			<tr class="dtl">	
				...
				<td colspan="3"><t:codeValue items="${FTZ_MSG_STATUS }" key="${FTZ210208Form.ftzInTxnDtl.chkStatus }" type="text"  cssClass="input-large" readonly="true"/></td>
			</tr>
			<tr class="dtl">	
				...
				<td><t:dateTimeFormat type="text" value="${FTZ210208Form.ftzInTxnDtl.makDatetime }" format="datetime" name="ftzInTxnDtl.makDatetime" cssClass="input-large" readonly="true"/></td>
			</tr>
			<tr class="dtl">	
				...
				<td><t:dateTimeFormat type="text" value="${FTZ210208Form.ftzInTxnDtl.chkDatetime }" format="datetime" name="ftzInTxnDtl.chkDatetime" cssClass="input-large" readonly="true"/></td>
			</tr>
			<tr class="dtl">	
