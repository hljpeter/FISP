...
$(".tbl_page_body table tr ").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210301/Input/Dtl/Init?ftzOffMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
});

//$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210301/Input/Qry");
...
$("#del").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210301/Input/DelMsg");
			$("#form").submit();
		} else {
			return false;
		}
...
$("#sbm").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#makDatetime").val(selectedRow.makDatetime);
			$("#msgStatus").val(selectedRow.msgStatus);
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210301/Input/SubmitMsg");
			$("#form").submit();
		} else {
			return false;
		}
...
$("#upt").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		selectedRow = eval("(" + selectedRow + ")"); 
		$("#makDatetime").val(selectedRow.makDatetime);
		showDialogAndRefresh('${pageContext.request.contextPath}/FTZ210301/Input/UptMsg/Init?ftzOffMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
		//window.location.href = '${pageContext.request.contextPath}/FTZ210301/Input/Qry?ftzOffMsgCtlVO.branchId=${FTZ210301Form.ftzOffMsgCtlVO.branchId }&ftzOffMsgCtlVO.startDate=${FTZ210301Form.ftzOffMsgCtlVO.startDate }&ftzOffMsgCtlVO.endDate=${FTZ210301Form.ftzOffMsgCtlVO.endDate }&ftzOffMsgCtlVO.msgNo=${FTZ210301Form.ftzOffMsgCtlVO.msgNo }&ftzOffMsgCtlVO.msgStatus=${FTZ210301Form.ftzOffMsgCtlVO.msgStatus }';
	}
});
...
// add
$("#add").click(function() {
	showDialogAndRefresh('${pageContext.request.contextPath}/FTZ210301/Input/AddMsg/Init', '500', '1040');
	//window.location.href = '${pageContext.request.contextPath}/FTZ210301/Input/Qry?ftzOffMsgCtlVO.startDate=' 
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210301.input"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/FTZ210301/Input/Qry" method="post" modelAttribute="FTZ210301Form" class="form-horizontal">
		...
		<table class="tbl_search">
			...
			<tr>	
				<td class="label_td" colspan="4" style="text-align:right;"><input type="submit" id="qry" name="btn" class="btn btn-primary" value="查询批量"/></td><!-- i18n -->
			</tr>
	    </table>											
	</form:form>
</div>
...
<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
	<div class="leftPage">
		<util:pagination page="${page }" action="/FTZ210301/Input/Qry" query="ftzOffMsgCtlVO.branchId=${FTZ210301Form.ftzOffMsgCtlVO.branchId }&ftzOffMsgCtlVO.startDate=${FTZ210301Form.ftzOffMsgCtlVO.startDate }&ftzOffMsgCtlVO.endDate=${FTZ210301Form.ftzOffMsgCtlVO.endDate }&ftzOffMsgCtlVO.msgId=${FTZ210301Form.ftzOffMsgCtlVO.msgId }&ftzOffMsgCtlVO.msgStatus=${FTZ210301Form.ftzOffMsgCtlVO.msgStatus }" />
	</div>
</div>
<div class="row">
