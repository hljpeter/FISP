<!-- 6.3.4　信用证保兑（210304） - 进口应付 / 录入查询页面 -->
...
$(".tbl_page_body table tr ").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210304/Input/Dtl/Init?ftzOffMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
});

//$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210304/Input/Qry");
...
$("#upt").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		selectedRow = eval("(" + selectedRow + ")"); 
		$("#makDatetime").val(selectedRow.makDatetime);
		showDialog('${pageContext.request.contextPath}/FTZ210304/Input/UptMsg/Init?ftzOffMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
		window.location.href = '${pageContext.request.contextPath}/FTZ210304/Input/Qry?ftzOffMsgCtlVO.branchId=${FTZ210304Form.ftzOffMsgCtlVO.branchId }&ftzOffMsgCtlVO.startDate=${FTZ210304Form.ftzOffMsgCtlVO.startDate }&ftzOffMsgCtlVO.endDate=${FTZ210304Form.ftzOffMsgCtlVO.endDate }&ftzOffMsgCtlVO.msgNo=${FTZ210304Form.ftzOffMsgCtlVO.msgNo }&ftzOffMsgCtlVO.msgStatus=${FTZ210304Form.ftzOffMsgCtlVO.msgStatus }';
	}
});
...
// add
$("#add").click(function() {
	showDialogAndRefresh('${pageContext.request.contextPath}/FTZ210304/Input/AddMsg/Init', '500', '1040');
	//window.location.href = '${pageContext.request.contextPath}/FTZ210304/Input/Qry?ftzOffMsgCtlVO.startDate=' 
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210304.input"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/FTZ210304/Input/Qry" method="post" modelAttribute="FTZ210304Form" class="form-horizontal">
