...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210306.auth.msg"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/FTZ210306/Auth/DtlMsg/Auth" method="post" modelAttribute="FTZ210306Form" class="form-horizontal">
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" action="/FTZ210306/Auth/DtlMsg/Init" query="ftzOffMsgCtl.msgId=${FTZ210301Form.ftzOffMsgCtl.msgId }" />
		</div>
	</div>
</div>
