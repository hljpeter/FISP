...
$(".tbl_page_body table tr").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210306/Qry/DtlTxn/Init?ftzOffTxnDtl.msgId=' 
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210306.qry.msg"/></div>
<!-- body -->
<div class="row">
