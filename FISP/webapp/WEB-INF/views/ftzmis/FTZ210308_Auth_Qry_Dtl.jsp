<!-- 6.3.8　信用证保兑（出口应收）（210308） / 审核 - 批量页面 -->
...
$("#dtl").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210308/Auth/DtlMsg/Init?FtzOffMsgCtl.msgId="+ ${FTZ210308Form.ftzOffMsgCtl.msgId });
		$("#form").submit();
	}
});
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210308.auth.msg"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/FTZ210308/Auth/DtlMsg/Auth" method="post" modelAttribute="FTZ210308Form" class="form-horizontal">
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" action="/FTZ210308/Auth/DtlMsg/Init" query="ftzOffMsgCtl.msgId=${FTZ210301Form.ftzOffMsgCtl.msgId }" />
		</div>
	</div>
</div>
