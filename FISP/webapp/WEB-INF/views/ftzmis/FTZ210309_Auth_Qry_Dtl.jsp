...
$("#dtl").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210309/Auth/DtlMsg/Init?FtzOffMsgCtl.msgId="+ ${FTZ210309Form.ftzOffMsgCtl.msgId });
		$("#form").submit();
	}
});
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" action="/FTZ210309/Auth/DtlMsg/Init" query="ftzOffMsgCtl.msgId=${FTZ210301Form.ftzOffMsgCtl.msgId }" />
		</div>
	</div>
</div>
