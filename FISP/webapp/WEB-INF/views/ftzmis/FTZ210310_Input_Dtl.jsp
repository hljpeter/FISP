<script type="text/javascript">
	$(function() {
		...
		.bind(
				...
				function() {
					...
					window
							.showModalDialog(
									'${pageContext.request.contextPath}/FTZ210310/QryDtlDtl?selected_msgId='
											+ selected_msgId
											+ "&selected_seqNo="
											+ selected_seqNo,
									window,
	...
	function addDetailDtl() {
		...
		window
				.showModalDialog(
						'${pageContext.request.contextPath}/FTZ210310/AddDtlDtlInit?selected_msgId='
								+ selected_msgId,
						window,
						'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
		queryFTZ210310();
	...
	function updDetailDtl() {
		...
		if (null == selected_seqNo || "" == selected_seqNo) {
			...
			if ("02" == selected_chkStatus || "04" == selected_chkStatus) {
				window
						.showModalDialog(
								'${pageContext.request.contextPath}/FTZ210310/UpdDtlDtlInit?selected_msgId='
										+ selected_msgId + "&selected_seqNo="
										+ selected_seqNo,
								window,
								'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
