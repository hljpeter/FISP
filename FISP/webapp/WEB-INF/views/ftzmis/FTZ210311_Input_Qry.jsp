<script type="text/javascript">
	$(function() {
		...
		.bind(
				...
				function() {
					...
					window
							.showModalDialog(
									'${pageContext.request.contextPath}/FTZ210311/QryDtl?selected_msgId='
											+ selected_msgId,
									window,
	...
	function addDetail() {
		window
				.showModalDialog(
						'${pageContext.request.contextPath}/FTZ210311/AddDtlInit',
						window,
						'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
		queryFTZ210311();
	}
	function updDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			if ("01" == selected_msgType || "04" == selected_msgType|| "02" == selected_msgType) {
				window
						.showModalDialog(
								'${pageContext.request.contextPath}/FTZ210311/UpdDtlInit?selected_msgId='
										+ selected_msgId,
								window,
								'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
				queryFTZ210311();
