...
<div class="page_title"><spring:message code="ftzmis.title.MsgResend.qry.dtl.dtl" /></div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}//Qry"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<t:moneyFormat type="text"
						value="${FTZMsgResendForm.ftzInTxnDtl.amount}"
