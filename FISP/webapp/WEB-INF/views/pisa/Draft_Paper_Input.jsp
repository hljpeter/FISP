<!-- title -->
<div class="page_title">纸质商业汇票（承兑/付款）补录</div>
		...
		<div  class="tbl_search" style="padding: 10px;">
			<table class="tbl_search">
				...
				<tr>
					...
					<td>
						<t:dateTimeFormat type="text" value="${draft_Paper_Form.bizDraftAcptList.startDate }" cssClass=".input-small" format="date"  readonly="true"/>
					</td>
				...
				<tr>
					...
					<td>
						<t:dateTimeFormat type="text" value="${draft_Paper_Form.bizDraftAcptList.endDate }" cssClass=".input-small" format="date" readonly="true"/>
					</td>
				...
				<tr>
					...
					<td>
						<t:dateTimeFormat type="text" value="${draft_Paper_Form.bizDraftAcptList.payDate }" cssClass=".input-small" format="date" readonly="true"/>
					</td>
			...
			<table class="tbl_search">
				...
				<tr>
					...
					<td>
						<t:dateTimeFormat type="text" value="${draft_Paper_Form.bizDraftAcptList.acptDate }" cssClass=".input-small" format="date" readonly="true"/>
					</td>
				</tr>
				<tr>
			...
			<table class="tbl_search">
				...
				<tr>
					...
					<td>
						<t:dateTimeFormat type="text" value="${draft_Paper_Form.bizDraftAcptList.advDate }" cssClass=".input-small" format="date" readonly="true"/>
					</td>
		    		<td class="label_td">逾期垫款核销日期：</td>
					<td>
						<t:dateTimeFormat type="text" value="${draft_Paper_Form.bizDraftAcptList.woffDate }" cssClass=".input-small" format="date" readonly="true"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
		    		<td class="label_td">补录附言：</td>
					<td colspan="3">
						<form:textarea path="remark" class="span9" rows="1"/>
					</td>
				</tr>
	    	</table>
	    </div>											
