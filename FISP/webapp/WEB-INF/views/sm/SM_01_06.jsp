...
<!--
	...
	function auth() {
		...
		form.action = "${pageContext.request.contextPath}/sm01/06/auth";
	...
	function reject() {
		var form = document.getElementById("form_04DetailSearch");
		form.action = "${pageContext.request.contextPath}/sm01/06/reject";
...
<div class="row" style="margin-bottom: 40px;">
	<form:form id="form_04DetailSearch" action="${pageContext.request.contextPath}/sm01/05/detailSearch_04" method="post" modelAttribute="orgInfTmpForm" class="form-horizontal">
		<table class="tbl_search">
			...
			<tr>
				...
				<td colspan="3">
					<form:input id="suprorgid" path="orgInfTmp.suprorgid" type="text" class=".input-small" readonly="true"/>
				</td>
			</tr>
			<tr>
				<td class="label_td"><spring:message code="index.label.sm.SuperiorOrganizationName"/></td>
				<td colspan="3">
					<form:input id="suprorgname" path="orgInfTmp.suprorgname" type="text" class="span8" readonly="true"/>
				</td>
			<tr>
