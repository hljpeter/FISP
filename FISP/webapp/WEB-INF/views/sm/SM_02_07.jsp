<script type="text/javascript">
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/sm02/07/search";
		form.submit();
	}
	//detail button
...
<!-- title -->
<div class="page_title"><spring:message code="index.label.sm.RoleInfoQuery"/></div>

<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/sm02/07/init" method="post" modelAttribute="roleInfForm" class="form-horizontal">
	...
	<table class="table table-striped table-bordered table-condensed tbl_page">
      <thead>
        <tr>
        	...
        	<th class="tbl_page_th" width="100px"><spring:message code="index.label.sm.RoleId"/></th>
          	<th class="tbl_page_th" width="200px"><spring:message code="index.label.sm.RoleName"/></th>
          	...
          	<th class="tbl_page_th" width="150px"><spring:message code="index.label.sm.CreateOrgName"/></th>
      ...
      <form:form id="roleInfForm" action="${pageContext.request.contextPath}" modelAttribute="roleInfForm">
        ...
        <c:forEach var="dto" items="${page.content}" varStatus="i">
          <tr>
            ...
            <td class="tbl_page_td_left vtip" width="100px">${dto.roleid}</td>
            <td class="tbl_page_td_left vtip" width="200px"> ${dto.rolename} </td>
            ...
            <td class="tbl_page_td_left" width="50px">
	           	<div align="center" style="height: 25px">
					<input type="button" id="detailBtn" class="btn btn-small" onclick="detailSearch('${f:h(dto.roleid)}')" value="<spring:message code="dp.lable.detail"/>">
               </div>
            </td>
          </tr>
        </c:forEach>
...
<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
	<div class="leftPage">
		<util:pagination page="${page}" query="roleid=${roleInfForm.roleid}&rolename=${roleInfForm.rolename}" />
	</div>
</div>
