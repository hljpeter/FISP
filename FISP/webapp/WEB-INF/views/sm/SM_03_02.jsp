...
<script type="text/javascript">
	...
	function addGo() {
		...
		form.action = "${pageContext.request.contextPath}/sm03/02/init";
		form.submit();
	}
	...
	function add() {
		...
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/sm03/02/add";
...
<div class="row" style="margin-bottom: 20px;">
	<form:form id="form" action="${pageContext.request.contextPath}/sm03/02/init" method="post" modelAttribute="userInfTmpForm" class="form-horizontal">
								     					...
								     					<tr><td>
													    	...
													    	<%	
												    			...
												    			for (RoleInf roleInf : list_role) {
												    				...
												    				String check = "";
												    				if(null != userSelectRoles && userSelectRoles.size() > 0){
			...
			<tr>
				...
				<td>
					<select id="loginorg" name="loginorg" >
						<c:forEach var="dto2" items="${SelectedOrg }" varStatus="i">
							<c:if test="${dto2.orgid eq userInfTmpForm.loginorg }">
          						<option selected="selected" value="${dto2.orgid}">${dto2.orgid}-${dto2.orgname}</option>
          					</c:if>
          					<c:if test="${dto2.orgid ne userInfTmpForm.loginorg }">
          						<option value="${dto2.orgid}">${dto2.orgid}-${dto2.orgname}</option>
          					</c:if>
        				</c:forEach>
					</select>
