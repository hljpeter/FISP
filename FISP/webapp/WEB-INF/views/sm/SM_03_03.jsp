...
<script type="text/javascript">
	...
	function modify() {
		...
		form.action = "${pageContext.request.contextPath}/sm03/03/modify";
...
<div class="row" style="margin-bottom: 20px;">
	<form:form id="form" action="${pageContext.request.contextPath}/sm03/03/init" method="post" modelAttribute="userInfForm" class="form-horizontal">
