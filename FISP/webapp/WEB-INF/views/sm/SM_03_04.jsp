<script type="text/javascript">
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/sm03/04/search";
		form.submit();
	}
	//detail button
	function detailSearch(id) {
		...
		window.showModalDialog('${pageContext.request.contextPath}/sm03/05/detailSearch_04?userInfTmp.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
...
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/sm03/04/init" method="post" modelAttribute="userInfTmpForm" class="form-horizontal">
