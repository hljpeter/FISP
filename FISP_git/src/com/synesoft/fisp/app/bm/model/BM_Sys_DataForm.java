...
public class BM_Sys_DataForm implements Serializable {
	
	private static final long serialVersionUID = 1L;

	private SysChgSysLogWithBLOBs sysChgSysLog=new SysChgSysLogWithBLOBs();
	...
	/**
	 * @return the sysChgSysLog
	 */
	public SysChgSysLogWithBLOBs getSysChgSysLog() {
		return sysChgSysLog;
	}


	/**
	 * @param sysChgSysLog the sysChgSysLog to set
	 */
	public void setSysChgSysLog(SysChgSysLogWithBLOBs sysChgSysLog) {
		this.sysChgSysLog = sysChgSysLog;
	}
