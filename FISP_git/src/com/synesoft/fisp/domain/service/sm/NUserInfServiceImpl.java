 ...
 */
@Service("nuserInfService")
public class NUserInfServiceImpl implements UserInfService {
...
//		}
	...
	public void transAddByMode(UserInfTmpForm form){
		...
		temp.setCreateorg(form.getUserOrgInfArr().get(0));
		temp.setLoginorg(form.getUserOrgInfArr().get(0));
