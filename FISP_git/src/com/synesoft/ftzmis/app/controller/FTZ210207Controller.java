...
/**
 * 6.2.6　应付保函/备用证（210207）
 * @author yyw
 * @date 2013-12-25
 */
@Controller
@RequestMapping(value = "FTZ210207")
public class FTZ210207Controller {
	private static final Logger log = LoggerFactory.getLogger(FTZ210207Controller.class);
	...
	@ModelAttribute
	public FTZ210207Form setForm() {
		return new FTZ210207Form();
	}

	/**
	 * 一级页面 - 初始化
	 * 跳转FTZ210207_Input_Qry.jsp
	 * @return
	 */
//	@RequestMapping("/AddQry")
//	public String qryInit() {
//		log.info("FTZ210207Controller.qryInit() start ...");
//		return "ftzmis/FTZ210207_Input_Qry";
//		//return "forward:/FTZ210207/Input/Qry";
//	}
	 ...
	 */
	@RequestMapping("/AddQry")
	public String inputQry( Model model, FTZ210207Form form,
			@PageableDefaults Pageable pageable) {
		log.info("FTZ210207Controller.inputQry() start ...");

//		if (result.hasErrors()) {
//			return "ftzmis/FTZ210207_Input_Qry";
//		}
		FtzInMsgCtlVO vo = new FtzInMsgCtlVO();
		vo.setMsgNo(CommonConst.MSG_NO_210207);
		// data ready
		...
		try {
			Page<FtzInMsgCtlVO> page = ftz210207Service.transQueryMsgPage(pageable, vo);
	...
	/**
	 * 跳转到2级页面
	 * 跳转FTZ210207_Input_Qry_Dtl.jsp
	 * @return
	 */
	@SuppressWarnings("unchecked")
	@RequestMapping("/Input/Dtl/Init")
	public String inputDtlInit(@Validated({FTZInFormMsgKey.class}) FTZ210207Form form, BindingResult result,  
			@PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210207Controller.inputDtlInit() start ...");
		...
		try {
			Map<String, Object> map = ftz210207Service.transQueryMsgAndTxnDetail(pageable, form.getFtzInMsgCtl(), null);
			...
			return "ftzmis/FTZ210207_Input_Qry_Dtl";
		} catch (BusinessException e) {
	...
	public String inputAddMsgInit(FTZ210207Form form, BindingResult result, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210207Controller.inputAddMsgInit() start ...");
	...
	public String inputAddMsgSubmit(FTZ210207Form form, BindingResult result, Model model) {
		log.info("FTZ210207Controller.inputAddMsgSubmit() start ...");
		...
		try {
			...
			ftz210207Service.transUpdateAddMsgCtl(ctl, CommonConst.MSG_NO_210207);
	...
	public String inputDtlRefresh(FTZ210207Form form, BindingResult result, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210207Controller.inputDtlRefresh() start ...");
	...
	public String inputUptMsgInit(@Validated({FTZInFormMsgKey.class}) FTZ210207Form form, BindingResult result, 
			@PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210207Controller.inputUptMsgInit() start ...");

		if (result.hasErrors()) {
			return "ftzmis/FTZ210207_Input_Qry";
		}
		
		return "forward:/FTZ210207/Input/Dtl/Init?actionFlag=" + CommonConst.ACTION_FLAG_UPT_MSG;
	...
	public String inputUptMsgSubmit(FTZ210207Form form, BindingResult result, Model model) {
		log.info("FTZ210207Controller.inputUptMsgSubmit() start ...");
		...
		try {
			...
			ftz210207Service.transUpdateMsgCtl(form.getFtzInMsgCtl(), CommonConst.FTZ_MSG_EDIT_FLAG_UPDATE);
			...
			return "forward:/FTZ210207/Input/Dtl/Init?actionFlag=" + CommonConst.ACTION_FLAG_UPT_MSG;
			//return "forward:/FTZ210207/Input/Dtl/Refresh";
		} catch (BusinessException e) {
	...
	public String inputDelMsg(@Validated({FTZInFormMsgKey.class}) FTZ210207Form form, BindingResult result, Model model) { // TODO validate
		log.info("FTZ210207Controller.inputDelMsg() start ...");
			...
			if (null != ftzInTxnDtls) {
				for (FtzInTxnDtl ftzInTxnDtl : ftzInTxnDtls) {
					if (CommonConst.FTZ_MSG_STATUS_AUTH_SUCC.equals(ftzInTxnDtl
						...
						return "forward:/FTZ210207/AddQry";
					}
				}
			}
			
			ftz210207Service.transDeleteMsgCtl(form.getFtzInMsgCtl());
	...
	public String inputSubmitMsg(@Validated({FTZInFormMsgKey.class}) FTZ210207Form form, BindingResult result, Model model) {
		log.info("FTZ210207Controller.inputSubmitMsg() start ...");
		...
		try {
			...
			ftz210207Service.transUpdateSubmitMsgCtl(form.getFtzInMsgCtl());
	...
	/**
	 * 新增交易 - 初始化
	 * 跳转FTZ210207_Input_Qry_Dtl_Dtl.jsp
	 * @return
	 */
	@RequestMapping("/Input/AddTxn/Init")
	public String inputAddTxnInit(@Validated({FTZInFormMsgKey.class}) FTZ210207Form form, BindingResult result, Model model) {
		log.info("FTZ210207Controller.inputAddTxnInit() start ...");
		...
		try {
			...
			//String seqNo = ftz210207Service.transQueryTxnDtlMaxSeqNo(txn);
			...
			return "ftzmis/FTZ210207_Input_Qry_Dtl_Dtl";
		} catch (BusinessException e) {
			log.error("Submit FtzInMsgCtl failure!" + e.getMessage());
			model.addAttribute("errmsg", e.getResultMessages());
			return "ftzmis/FTZ210207_Input_Qry_Dtl";
	...
	public String inputAddTxnSubmit(FTZ210207Form form, BindingResult result, Model model) {
		log.info("FTZ210207Controller.inputAddTxnSubmit() start ...");
		...
		try {
			...
			String seqNo = ftz210207Service.transQueryTxnDtlMaxSeqNo(form.getFtzInTxnDtl());
			form.getFtzInTxnDtl().setSeqNo(seqNo);
			ftz210207Service.transUpdateAddTxnDtl(form.getFtzInTxnDtl());
...
//			ftz210207Service.transUpdateMsgCtl(form.getFtzInMsgCtl(), CommonConst.FTZ_MSG_EDIT_FLAG_UPDATE);
	...
	/**
	 * 修改交易 - 初始化
	 * forward:/FTZ210207/Input/DtlTxn/Init
	 * @return
	 */
	@RequestMapping("/Input/UptTxn/Init")
	public String inputUptTxnInit(@Validated({FTZInFormTxnKey.class}) FTZ210207Form form, BindingResult result, Model model) {
		log.info("FTZ210207Controller.inputUptTxnInit() start ...");

		return "forward:/FTZ210207/Input/DtlTxn/Init?actionFlag=" + CommonConst.ACTION_FLAG_UPT_TXN;
	...
	public String inputUptTxnSubmit(FTZ210207Form form, BindingResult result, Model model) {// TODO
		log.info("FTZ210207Controller.inputUptTxnSubmit() start ...");
		...
		try {
			...
			ftz210207Service.transUpdateTxnDtl(form.getFtzInTxnDtl());
			form.getFtzInTxnDtl().setTranDate(DateUtil
					.getFormatDateAddSprit(form.getFtzInTxnDtl().getTranDate()));//记账日期格式化
			form.getFtzInTxnDtl().setValueDate(DateUtil
					.getFormatDateAddSprit(form.getFtzInTxnDtl().getValueDate()));//起息日格式化
			...
			ftzInTxnDtl=ftz210207Service.transQueryTxnById(ftzInTxnDtl);
	...
	public String inputDtlTxnInit(@Validated({FTZInFormTxnKey.class}) FTZ210207Form form, BindingResult result, Model model) {// TODO
		log.info("FTZ210207Controller.inputDtlTxnInit() start ...");
		...
		try {
			FtzInTxnDtl txn = ftz210207Service.transQueryTxnById(form.getFtzInTxnDtl());
...
//			txn.setExpirationDate(DateUtil.getFormatDateAddSprit(txn.getExpirationDate()));
	...
	/**
	 * 删除交易明细 
	 * forward:/FTZ210207/Input/Dtl/Refresh
	 * @return
	 */
	@RequestMapping("/Input/DelTxn/Submit")
	public String inputDelTxnSubmit(@Validated({FTZInFormTxnKey.class}) FTZ210207Form form, BindingResult result, Model model) {// TODO
		log.info("FTZ210207Controller.inputDelTxnSubmit() start ...");
		...
		try {
			...
			ftz210207Service.transUpdateDeleteTxnDtl(form.getFtzInTxnDtl());
...
//		}
	 ...
	 * 跳转FTZ210207_Auth_Qry_Dtl.jsp
	 * @return
	 */
	@SuppressWarnings("unchecked")
	@RequestMapping("/Auth/DtlMsg/Init")
	public String authDtlMsgInit(FTZ210207Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210207Controller.authDtlMsgInit() start ...");

		try {
			String status = CommonConst.PAGE_SEARCH_ALL_DTL.equals(form.getOperFlag())? null: CommonConst.FTZ_MSG_STATUS_INPUT_COMPLETED;
			
			Map<String, Object> map = ftz210207Service.transQueryMsgAndTxnDetail(pageable, form.getFtzInMsgCtl(), status);
			...
			return "ftzmis/FTZ210207_Auth_Qry_Dtl";
		} catch (BusinessException e) {
			log.error("Init FtzInTxnDtl failure, the MsgId is invalid!" + e.getMessage());
			model.addAttribute("errmsg", e.getResultMessages());
			return "ftzmis/FTZ210207_Auth_Qry";
		}
	}
	
	/**
	 * 查询交易 - 明细
	 * 跳转FTZ210207_Auth_Qry_Dtl_Dtl.jsp
	 * @return
	 */
	@RequestMapping("/Auth/DtlTxn/Init")
	public String authDtlTxnInit(FTZ210207Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210207Controller.authDtlTxnInit() start ...");
		...
		try {
			...
			msg=ftz210207Service.transQueryMsgById(msg);
			form.setFtzInMsgCtl(msg);
//			int ret = ftz210207Service.getAuthTxnCountById(form.getFtzInTxnDtl());
//			if (ret == 1) {
//				form.setMsg("i.ftzmis.210207.0006");
//			}
			
			return "ftzmis/FTZ210207_Auth_Qry_Dtl_Dtl";
		} catch (BusinessException e) {
			log.error("Init FtzInTxnDtl failure, the MsgId is invalid!" + e.getMessage());
			model.addAttribute("errmsg", e.getResultMessages());
	...
	public String authDtlMsgAuth(FTZ210207Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210207Controller.authDtlMsgAuth() start ...");
	...
	public String authDtlTxnAuth(FTZ210207Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210207Controller.authDtlTxnAuth() start ...");
		...
		try {
			...
			if (userInfo.getUserid().equals(form.getFtzInTxnDtl().getMakUserId())) {
				model.addAttribute(ResultMessages.error().add(
						"e.ftzmis.210101.0025"));
				return "forward:/FTZ210207/Auth/DtlTxn/Init";
			}
			ftz210207Service.authTxnDtl(form.getFtzInTxnDtl(), form.getOperFlag());
...
//			}
	...
	public String authDtlTxnNext(FTZ210207Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210207Controller.authDtlTxnNext() start ...");

		try {
			FtzInTxnDtl result = ftz210207Service.getNextAuthTxnById(form.getFtzInTxnDtl());
	...
	public String queryDtl(Model model, FTZ210207Form form,
			@PageableDefaults Pageable pageable) {
		...
		if (null == result_FtzInMsgCtl) {
			...
			return "ftzmis/FTZ210207_Qry_Dtl";
		}
	}

	@RequestMapping("QryDtlDtl")
	public String queryDtlDtl(Model model, FTZ210207Form form) {
		...
		return "ftzmis/FTZ210207_Qry_Dtl_Dtl";
	}
	
	@Autowired
	private NumberService numberService;
	@Autowired
	private FTZInCommonService ftz210207Service;
