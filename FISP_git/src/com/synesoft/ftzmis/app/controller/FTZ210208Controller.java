...
//			ftz210208Service.transUpdateMsgCtl(form.getFtzInMsgCtl(), CommonConst.FTZ_MSG_EDIT_FLAG_UPDATE);
	...
	public String inputUptTxnSubmit(FTZ210208Form form, BindingResult result, Model model) {// TODO
		...
		try {
			...
			ftzInTxnDtl=ftz210208Service.transQueryTxnById(ftzInTxnDtl);
...
//		}
	...
	public String authDtlTxnInit(FTZ210208Form form, @PageableDefaults Pageable pageable, Model model) {
		...
		try {
			...
			msg=ftz210208Service.transQueryMsgById(msg);
	...
	public String authDtlTxnAuth(FTZ210208Form form, @PageableDefaults Pageable pageable, Model model) {
		...
		try {
			...
			if (userInfo.getUserid().equals(form.getFtzInTxnDtl().getMakUserId())) {
				model.addAttribute(ResultMessages.error().add(
						"e.ftzmis.210101.0025"));
				return "forward:/FTZ210208/Auth/DtlTxn/Init";
			}
...
//			}
	...
	public String queryDtl(Model model, FTZ210208Form form,
			@PageableDefaults Pageable pageable) {
		...
		if (null == result_FtzInMsgCtl) {
			...
			return "ftzmis/FTZ210208_Qry_Dtl";
		}
	}

	@RequestMapping("QryDtlDtl")
	public String queryDtlDtl(Model model, FTZ210208Form form) {
		...
		return "ftzmis/FTZ210208_Qry_Dtl_Dtl";
	}
