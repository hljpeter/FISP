 ...
 */
@Controller
@RequestMapping(value = "FTZ210301")
public class FTZ210301Controller {
	private static final Logger log = LoggerFactory.getLogger(FTZ210301Controller.class);
	...
	@ModelAttribute
	public FTZ210301Form setForm() {
		return new FTZ210301Form();
	}

	/** ====================================== 录入 ====================================== */
	/**
	 * 查询批量 - 初始化
	 * 跳转FTZ210301_Input_Qry.jsp
	 * @return
	 */
	@RequestMapping("/Input/Qry/Init")
	public String inputQryInit() {
		log.info("FTZ210301Controller.inputQryInit() start ...");
	...
	public String inputQry(FTZ210301Form form, 
			@PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210301Controller.inputQry() start ...");

		FtzOffMsgCtlVO vo = new FtzOffMsgCtlVO();
		vo.setMsgNo(CommonConst.MSG_NO_210301);
	...
	public String inputDtlInit(FTZ210301Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210301Controller.inputDtlInit() start ...");

		try {
			Map<String, Object> map = ftz210301Service.getMsgAndTxnDetail(pageable, form.getFtzOffMsgCtl(), null);
			...
			return "ftzmis/FTZ210301_Input_Qry_Dtl";
		} catch (BusinessException e) {
	...
	public String inputAddMsgInit(FTZ210301Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210301Controller.inputAddMsgInit() start ...");
...
//		ctl.setMsgId(numberService.getSysIDSequence(32));
	...
	public String inputAddMsgSubmit(FTZ210301Form form, Model model) {
		log.info("FTZ210301Controller.inputAddMsgSubmit() start ...");
	...
	public String inputDtlRefresh(FTZ210301Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210301Controller.inputDtlRefresh() start ...");
	...
	public String inputUptMsgInit(FTZ210301Form form, 
			@PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210301Controller.inputUptMsgInit() start ...");

		return "forward:/FTZ210301/Input/Dtl/Init?actionFlag=" + CommonConst.ACTION_FLAG_UPT_MSG;
	...
	public String inputUptMsgSubmit(FTZ210301Form form, Model model) {
		log.info("FTZ210301Controller.inputUptMsgSubmit() start ...");

		form.setActionFlag(CommonConst.ACTION_FLAG_UPT_MSG);
		
		try {
			ftz210301Service.updateMsgCtl(form.getFtzOffMsgCtl());
			
			model.addAttribute("successmsg", ResultMessages.success().add(ResultMessage.fromCode("i.ftzmis.210301.0001")));
...
//			return "ftzmis/FTZ210301_Input_Qry_Dtl";
	...
	public String inputDelMsg(FTZ210301Form form, Model model) {
		log.info("FTZ210301Controller.inputDelMsg() start ...");

		try {
			ftz210301Service.deleteMsgCtl(form.getFtzOffMsgCtl());

			log.info("Delete success");
			form.setActionFlag(CommonConst.ACTION_FLAG_DEL_MSG);
			model.addAttribute("successmsg", ResultMessages.success().add(ResultMessage.fromCode("i.ftzmis.210301.0007")));

			return "forward:/FTZ210301/Input/Qry";
//			return "ftzmis/FTZ210301_Input_Qry";
		} catch (BusinessException e) {
	...
	public String inputSubmitMsg(FTZ210301Form form, Model model) {
		log.info("FTZ210301Controller.inputSubmitMsg() start ...");

		try {
			ftz210301Service.submitMsgCtl(form.getFtzOffMsgCtl());
	...
	/**
	 * 新增交易 - 初始化
	 * 跳转FTZ210301_Input_Qry_Dtl_Dtl.jsp
	 * @return
	 */
	@RequestMapping("/Input/AddTxn/Init")
	public String inputAddTxnInit(FTZ210301Form form, Model model) {
		log.info("FTZ210301Controller.inputAddTxnInit() start ...");
...
//			txnDtl.setSeqNo(seqNo);
	...
	public String inputAddTxnSubmit(FTZ210301Form form, Model model) {
		log.info("FTZ210301Controller.inputAddTxnSubmit() start ...");

		form.setActionFlag(CommonConst.ACTION_FLAG_ADD_TXN);
		
		try {
			FtzOffTxnDtl txn = (FtzOffTxnDtl) form.getFtzOffTxnDtl().clone();
			ftz210301Service.addTxnDtl(txn);
...
//			return "ftzmis/FTZ210301_Input_Qry_Dtl_Dtl";
	...
	/**
	 * 修改交易 - 初始化
	 * forward:/FTZ210301/Input/DtlTxn/Init
	 * @return
	 */
	@RequestMapping("/Input/UptTxn/Init")
	public String inputUptTxnInit(FTZ210301Form form, Model model) {
		log.info("FTZ210301Controller.inputUptTxnInit() start ...");

		return "forward:/FTZ210301/Input/DtlTxn/Init?actionFlag=" + CommonConst.ACTION_FLAG_UPT_TXN;
	...
	public String inputUptTxnSubmit(FTZ210301Form form, Model model) {
		log.info("FTZ210301Controller.inputUptTxnSubmit() start ...");

		form.setActionFlag(CommonConst.ACTION_FLAG_UPT_TXN);
		
		try {
			FtzOffTxnDtl txn = (FtzOffTxnDtl) form.getFtzOffTxnDtl().clone();
			ftz210301Service.updateTxnDtl(txn);
			
			model.addAttribute("successmsg", ResultMessages.success().add(ResultMessage.fromCode("i.ftzmis.210301.0004")));
	...
	public String inputSubmitTxn(FTZ210301Form form, Model model) {
		log.info("FTZ210301Controller.inputSubmitTxn() start ...");

		form.setActionFlag(CommonConst.ACTION_FLAG_UPT_TXN);
		
		try {
			ftz210301Service.submitTxn(form.getFtzOffTxnDtl());
			
			model.addAttribute("successmsg", ResultMessages.success().add(ResultMessage.fromCode("i.ftzmis.210301.0009")));
			return "ftzmis/FTZ210301_Input_Qry_Dtl_Dtl";
		} catch (BusinessException e) {
			log.error("Update FtzOffTxnDtl failure!" + e.getMessage());
			model.addAttribute("errmsg", e.getResultMessages());
	...
	public String inputDtlTxnInit(FTZ210301Form form, Model model) {
		log.info("FTZ210301Controller.inputDtlTxnInit() start ...");

		try {
			FtzOffTxnDtl txn = ftz210301Service.getTxnById(form.getFtzOffTxnDtl());
	...
	/**
	 * 删除交易 - 提交
	 * forward:/FTZ210301/Input/Dtl/Refresh
	 * @return
	 */
	@RequestMapping("/Input/DelTxn/Submit")
	public String inputDelTxnSubmit(FTZ210301Form form, Model model) {
		log.info("FTZ210301Controller.inputDelTxnSubmit() start ...");

		try {
			ftz210301Service.deleteTxnDtl(form.getFtzOffTxnDtl());
			model.addAttribute("successmsg", ResultMessages.success().add(ResultMessage.fromCode("i.ftzmis.210301.0008")));
			
//			return "forward:/FTZ210301/Input/Dtl/Refresh";
			return "forward:/FTZ210301/Input/UptMsg/Init";
		} catch (BusinessException e) {
			log.error("Submit FtzOffTxnDtl failure!" + e.getMessage());
			model.addAttribute("errmsg", e.getResultMessages());
	 ...
	 * 跳转FTZ210301_Auth_Qry_Dtl.jsp
	 * @return
	 */
	@SuppressWarnings("unchecked")
	@RequestMapping("/Auth/DtlMsg/Init")
	public String authDtlMsgInit(FTZ210301Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210301Controller.authDtlMsgInit() start ...");

		try {
			String status = CommonConst.PAGE_SEARCH_ALL_DTL.equals(form.getOperFlag())? null: CommonConst.FTZ_MSG_STATUS_INPUT_COMPLETED;
			
			Map<String, Object> map = ftz210301Service.getMsgAndTxnDetail(pageable, form.getFtzOffMsgCtl(), status);
			
			form.setActionFlag(CommonConst.ACTION_FLAG_DTL_MSG);
			form.setFtzOffMsgCtl((FtzOffMsgCtl) map.get(DTL_MAP_KEY_MSG));
			model.addAttribute("page", (Page<FtzOffTxnDtl>) map.get(DTL_MAP_KEY_TXN));
			
			return "ftzmis/FTZ210301_Auth_Qry_Dtl";
		} catch (BusinessException e) {
			log.error("Init FtzOffTxnDtl failure, the MsgId is invalid!" + e.getMessage());
			model.addAttribute("errmsg", e.getResultMessages());
			return "ftzmis/FTZ210301_Auth_Qry";
		}
	}
	
	/**
	 * 查询交易 - 明细
	 * 跳转FTZ210301_Auth_Qry_Dtl_Dtl.jsp
	 * @return
	 */
	@RequestMapping("/Auth/DtlTxn/Init")
	public String authDtlTxnInit(FTZ210301Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210301Controller.authDtlTxnInit() start ...");

		try {
			FtzOffTxnDtl txn = ftz210301Service.getAuthTxnById(form.getFtzOffTxnDtl());
			form.setFtzOffTxnDtl(txn);

			int ret = ftz210301Service.getAuthTxnCountById(form.getFtzOffTxnDtl());
			if (ret == 1) {
				form.setMsg("i.ftzmis.210301.0006");
			}
			
			return "ftzmis/FTZ210301_Auth_Qry_Dtl_Dtl";
		} catch (BusinessException e) {
			log.error("Init FtzOffTxnDtl failure, the MsgId is invalid!" + e.getMessage());
			model.addAttribute("errmsg", e.getResultMessages());
	...
	public String authDtlMsgAuth(FTZ210301Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210301Controller.authDtlMsgAuth() start ...");

		try {
			ftz210301Service.authMsgCtl(form.getFtzOffMsgCtl());
			...
			model.addAttribute("errmsg", e.getResultMessages());
//			return "ftzmis/FTZ210301_Auth_Qry_Dtl";
			return "forward:/FTZ210301/Auth/DtlMsg/Init?operFlag=" + CommonConst.PAGE_SEARCH_NEED_CHK_DTL;
		}
	}
	...
	public String authDtlTxnAuth(FTZ210301Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210301Controller.authDtlTxnAuth() start ...");

		try {
			ftz210301Service.authTxnDtl(form.getFtzOffTxnDtl(), form.getOperFlag());

			FtzOffTxnDtl txn = ftz210301Service.getTxnById(form.getFtzOffTxnDtl());
			form.setFtzOffTxnDtl(txn);
			
			model.addAttribute("successmsg", ResultMessages.success().add(ResultMessage.fromCode("i.ftzmis.210301.0010")));
	...
	public String authDtlTxnNext(FTZ210301Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210301Controller.authDtlTxnNext() start ...");

		try {
			FtzOffTxnDtl result = ftz210301Service.getNextAuthTxnById(form.getFtzOffTxnDtl());
	...
	public String qryDtlMsgInit(FTZ210301Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210301Controller.qryDtlMsgInit() start ...");
		...
		try {
			...
			return "ftzmis/FTZ210301_Qry_Dtl";
		} catch (BusinessException e) {
	...
	/**
	 * 查询交易 - 明细
	 * 跳转FTZ210301_Qry_Dtl_Dtl.jsp
	 * @return
	 */
	@RequestMapping("/Qry/DtlTxn/Init")
	public String qryDtlTxnInit(FTZ210301Form form, @PageableDefaults Pageable pageable, Model model) {
		log.info("FTZ210301Controller.qryDtlTxnInit() start ...");
		...
		try {
			...
			return "ftzmis/FTZ210301_Qry_Dtl_Dtl";
		} catch (BusinessException e) {
