...
import com.synesoft.ftzmis.domain.repository.FTZ210106Repository;

@Service
public class FTZ210106ServiceImp implements FTZ210106Service {
	
	protected static String funcId ="FTZ_Add_210106";

	@Override
	public FtzInMsgCtl queryFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		return ftz210106Repos.queryFtzInMsgCtl(ftzInMsgCtl);
	}

	@Override
	public Page<FtzInMsgCtl> queryFtzInMsgCtlPageInput(Pageable pageable,
			FtzInMsgCtl ftzInMsgCtl) {
		return ftz210106Repos.queryFtzInMsgCtlPageInput(pageable, ftzInMsgCtl);
	}

	@Override
	public Page<FtzInMsgCtl> queryFtzInMsgCtlPage(Pageable pageable,
			FtzInMsgCtl ftzInMsgCtl) {
		return ftz210106Repos.queryFtzInMsgCtlPage(pageable, ftzInMsgCtl);
	}

	@Override
	public Page<FtzInTxnDtl> queryFtzInTxnDtlPage(Pageable pageable,
			FtzInTxnDtl ftzInTxnDtl) {
		return ftz210106Repos.queryFtzInTxnDtlPage(pageable, ftzInTxnDtl);
	}

	@Override
	public FtzInTxnDtl queryFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		return ftz210106Repos.queryFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int deleteFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		...
		ftz210106Repos.deleteFtzInTxnDtls(ftzInTxnDtl);
		...
		int i = ftz210106Repos.deleteFtzInMsgCtl(ftzInMsgCtl);
		return i;
	}
	...
	public int insertFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		...
		TlrLogPrint.tlrBizLogPrint(funcId, orgInfo.getOrgid(),
				...
				time.substring(0, 8), time.substring(8, 14), "",
				afterData.toString());
		return ftz210106Repos.insertFtzInMsgCtl(ftzInMsgCtl);
	}
	...
	public int updateFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl,
		...
		if (null == ftzInTxnDtls) {
			...
			return ftz210106Repos.updateFtzInMsgCtl(ftzInMsgCtl);
		} else {
	...
	public int deleteFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		...
		return ftz210106Repos.deleteFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int insertFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		...
		FtzInMsgCtl result_FtzInMsgCtl = ftz210106Repos
		...
		ftz210106Repos.updateFtzInMsgCtl(update_FtzInMsgCtl);
		...
		return ftz210106Repos.insertFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int updateFtzInTxnDtlSelective(FtzInTxnDtl ftzInTxnDtl) {
		...
		return ftz210106Repos.updateFtzInTxnDtlSelective(ftzInTxnDtl);
	}
	 ...
	 * 
	 * @see
	 * com.synesoft.ftzmis.domain.service.FTZ210106Service#queryFtzBankCode(
	 * com.synesoft.ftzmis.domain.model.FtzBankCode)
	 */
	@Override
	public FtzBankCode queryFtzBankCode(FtzBankCode ftzBankCode) {
		return ftz210106Repos.queryFtzBankCode(ftzBankCode);
	}

	@Resource
	protected FTZ210106Repository ftz210106Repos;

	@Override
	public FtzActMstr queryFtzActMstr(FtzActMstr ftzActMstr) {
		// TODO Auto-generated method stub
		return ftz210106Repos.queryFtzActMstr(ftzActMstr);
	}
}
