...
public class FTZ210112ServiceImp implements FTZ210112Service {
	...
	public int deleteFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		...
		return ftz210112Repos.deleteFtzInTxnDtl(ftzInTxnDtl);
	}
	 ...
	 * 
	 * @see
	 * com.synesoft.ftzmis.domain.service.FTZ210112Service#queryFtzActMstrs(
	...
	public int insertFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		...
		FtzInMsgCtl result_FtzInMsgCtl = ftz210112Repos
		...
		ftz210112Repos.updateFtzInMsgCtl(update_FtzInMsgCtl);
		...
		return ftz210112Repos.insertFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int updateFtzInTxnDtlSelective(FtzInTxnDtl ftzInTxnDtl) {
		...
		return ftz210112Repos.updateFtzInTxnDtlSelective(ftzInTxnDtl);
	}
