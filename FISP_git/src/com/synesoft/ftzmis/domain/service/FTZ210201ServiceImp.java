...
import com.synesoft.ftzmis.domain.repository.FTZ210201Repository;

@Service
public class FTZ210201ServiceImp implements FTZ210201Service {
	
	protected static String funcId ="FTZ_Add_210201";

	@Override
	public FtzInMsgCtl queryFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		return ftz210201Repos.queryFtzInMsgCtl(ftzInMsgCtl);
	}

	@Override
	public Page<FtzInMsgCtl> queryFtzInMsgCtlPageInput(Pageable pageable,
			FtzInMsgCtl ftzInMsgCtl) {
		return ftz210201Repos.queryFtzInMsgCtlPageInput(pageable, ftzInMsgCtl);
	}

	@Override
	public Page<FtzInMsgCtl> queryFtzInMsgCtlPage(Pageable pageable,
			FtzInMsgCtl ftzInMsgCtl) {
		return ftz210201Repos.queryFtzInMsgCtlPage(pageable, ftzInMsgCtl);
	}

	@Override
	public Page<FtzInTxnDtl> queryFtzInTxnDtlPage(Pageable pageable,
			FtzInTxnDtl ftzInTxnDtl) {
		return ftz210201Repos.queryFtzInTxnDtlPage(pageable, ftzInTxnDtl);
	}

	@Override
	public FtzInTxnDtl queryFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		return ftz210201Repos.queryFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int deleteFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		...
		ftz210201Repos.deleteFtzInTxnDtls(ftzInTxnDtl);
		...
		TlrLogPrint.tlrBizLogPrint("FTZ_Add_210201", orgInfo.getOrgid(),
				userInfo.getUserid(), userInfo.getUsername(), "D",
				time.substring(0, 8), time.substring(8, 14),
				beforeData.toString(), "");

		int i = ftz210201Repos.deleteFtzInMsgCtl(ftzInMsgCtl);
		return i;
	}
	...
	public int insertFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		...
		TlrLogPrint.tlrBizLogPrint("FTZ_Add_210201", orgInfo.getOrgid(),
				...
				time.substring(0, 8), time.substring(8, 14), "",
				afterData.toString());
		return ftz210201Repos.insertFtzInMsgCtl(ftzInMsgCtl);
	}
	...
	public int updateFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl,
		...
		if (null == ftzInTxnDtls) {
			...
			return ftz210201Repos.updateFtzInMsgCtl(ftzInMsgCtl);
		} else {
	...
	public int deleteFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		...
		return ftz210201Repos.deleteFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int insertFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		...
		FtzInMsgCtl result_FtzInMsgCtl = ftz210201Repos
		...
		ftz210201Repos.updateFtzInMsgCtl(update_FtzInMsgCtl);
		...
		return ftz210201Repos.insertFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int updateFtzInTxnDtlSelective(FtzInTxnDtl ftzInTxnDtl) {
		...
		return ftz210201Repos.updateFtzInTxnDtlSelective(ftzInTxnDtl);
	}
	 ...
	 * 
	 * @see
	 * com.synesoft.ftzmis.domain.service.FTZ210201Service#queryFtzBankCode(
	 * com.synesoft.ftzmis.domain.model.FtzBankCode)
	 */
	@Override
	public FtzBankCode queryFtzBankCode(FtzBankCode ftzBankCode) {
		return ftz210201Repos.queryFtzBankCode(ftzBankCode);
	}

	@Resource
	protected FTZ210201Repository ftz210201Repos;
}
