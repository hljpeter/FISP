...
import com.synesoft.ftzmis.domain.repository.FTZ210202Repository;
...
public class FTZ210202ServiceImp implements FTZ210202Service {
	...
	public Page<FtzInMsgCtl> queryFtzInMsgCtlPageInput(Pageable pageable,
		...
		return ftz210202Repos.queryFtzInMsgCtlPageInput(pageable, ftzInMsgCtl);
	}

	@Override
	public Page<FtzInMsgCtl> queryFtzInMsgCtlPage(Pageable pageable,
			FtzInMsgCtl ftzInMsgCtl) {
		return ftz210202Repos.queryFtzInMsgCtlPage(pageable, ftzInMsgCtl);
	}

	@Override
	public Page<FtzInTxnDtl> queryFtzInTxnDtlPage(Pageable pageable,
			FtzInTxnDtl ftzInTxnDtl) {
		return ftz210202Repos.queryFtzInTxnDtlPage(pageable, ftzInTxnDtl);
	}

	@Override
	public FtzInTxnDtl queryFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		return ftz210202Repos.queryFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int deleteFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		...
		ftz210202Repos.deleteFtzInTxnDtls(ftzInTxnDtl);
		...
		TlrLogPrint.tlrBizLogPrint("FTZ_Add_210202", orgInfo.getOrgid(),
				userInfo.getUserid(), userInfo.getUsername(), "D",
				time.substring(0, 8), time.substring(8, 14),
				beforeData.toString(), "");

		int i = ftz210202Repos.deleteFtzInMsgCtl(ftzInMsgCtl);
		return i;
	}
	...
	public int insertFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		...
		TlrLogPrint.tlrBizLogPrint("FTZ_Add_210202", orgInfo.getOrgid(),
				...
				time.substring(0, 8), time.substring(8, 14), "",
				afterData.toString());
		return ftz210202Repos.insertFtzInMsgCtl(ftzInMsgCtl);
	}
	...
	public int updateFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl,
		...
		if (null == ftzInTxnDtls) {
			...
			return ftz210202Repos.updateFtzInMsgCtl(ftzInMsgCtl);
		} else {
	...
	public int deleteFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		...
		return ftz210202Repos.deleteFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int insertFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		...
		FtzInMsgCtl result_FtzInMsgCtl = ftz210202Repos
		...
		ftz210202Repos.updateFtzInMsgCtl(update_FtzInMsgCtl);
		...
		return ftz210202Repos.insertFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int updateFtzInTxnDtlSelective(FtzInTxnDtl ftzInTxnDtl) {
		...
		return ftz210202Repos.updateFtzInTxnDtlSelective(ftzInTxnDtl);
	}
	 ...
	 * 
	 * @see
	 * com.synesoft.ftzmis.domain.service.FTZ210202Service#queryFtzBankCode(
	 * com.synesoft.ftzmis.domain.model.FtzBankCode)
	 */
	@Override
	public FtzBankCode queryFtzBankCode(FtzBankCode ftzBankCode) {
		return ftz210202Repos.queryFtzBankCode(ftzBankCode);
	}

	@Resource
	protected FTZ210202Repository ftz210202Repos;
}
