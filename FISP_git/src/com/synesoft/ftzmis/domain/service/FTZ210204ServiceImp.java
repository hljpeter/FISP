...
import com.synesoft.ftzmis.domain.repository.FTZ210204Repository;

@Service
public class FTZ210204ServiceImp implements FTZ210204Service {
	
	protected static String funcId ="FTZ_Add_210204";

	@Override
	public FtzInMsgCtl queryFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		return ftz210204Repos.queryFtzInMsgCtl(ftzInMsgCtl);
	}

	@Override
	public Page<FtzInMsgCtl> queryFtzInMsgCtlPageInput(Pageable pageable,
			FtzInMsgCtl ftzInMsgCtl) {
		return ftz210204Repos.queryFtzInMsgCtlPageInput(pageable, ftzInMsgCtl);
	}

	@Override
	public Page<FtzInMsgCtl> queryFtzInMsgCtlPage(Pageable pageable,
			FtzInMsgCtl ftzInMsgCtl) {
		return ftz210204Repos.queryFtzInMsgCtlPage(pageable, ftzInMsgCtl);
	}

	@Override
	public Page<FtzInTxnDtl> queryFtzInTxnDtlPage(Pageable pageable,
			FtzInTxnDtl ftzInTxnDtl) {
		return ftz210204Repos.queryFtzInTxnDtlPage(pageable, ftzInTxnDtl);
	}

	@Override
	public FtzInTxnDtl queryFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		return ftz210204Repos.queryFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int deleteFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		...
		ftz210204Repos.deleteFtzInTxnDtls(ftzInTxnDtl);
		...
		int i = ftz210204Repos.deleteFtzInMsgCtl(ftzInMsgCtl);
		return i;
	}
	...
	public int insertFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		...
		TlrLogPrint.tlrBizLogPrint(funcId, orgInfo.getOrgid(),
				...
				time.substring(0, 8), time.substring(8, 14), "",
				afterData.toString());
		return ftz210204Repos.insertFtzInMsgCtl(ftzInMsgCtl);
	}
	...
	public int updateFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl,
		...
		if (null == ftzInTxnDtls) {
			...
			return ftz210204Repos.updateFtzInMsgCtl(ftzInMsgCtl);
		} else {
	...
	public int deleteFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		...
		return ftz210204Repos.deleteFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int insertFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		...
		FtzInMsgCtl result_FtzInMsgCtl = ftz210204Repos
		...
		ftz210204Repos.updateFtzInMsgCtl(update_FtzInMsgCtl);
		...
		return ftz210204Repos.insertFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int updateFtzInTxnDtlSelective(FtzInTxnDtl ftzInTxnDtl) {
		...
		return ftz210204Repos.updateFtzInTxnDtlSelective(ftzInTxnDtl);
	}
	 ...
	 * 
	 * @see
	 * com.synesoft.ftzmis.domain.service.FTZ210204Service#queryFtzBankCode(
	 * com.synesoft.ftzmis.domain.model.FtzBankCode)
	 */
	@Override
	public FtzBankCode queryFtzBankCode(FtzBankCode ftzBankCode) {
		return ftz210204Repos.queryFtzBankCode(ftzBankCode);
	}

	@Resource
	protected FTZ210204Repository ftz210204Repos;
}
