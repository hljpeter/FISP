...
@Service("ftz210207Service")
public class FTZ210207ServiceImp extends FTZInCommonServiceImp {
	private static final Logger log = LoggerFactory.getLogger(FTZ210207ServiceImp.class);
	
	public FTZ210207ServiceImp() {
		super.funcId = CommonConst.FTZ_Add_210207;
	}
	...
	protected void addMsgLogic(FtzInMsgCtl ftzInMsgCtl) {
		log.debug("FTZ210207ServiceImp.addMsgLogic() start ...");
	...
	protected void addTxnLogic(FtzInTxnDtl ftzInTxnDtl) {
		log.debug("FTZ210207ServiceImp.addTxnLogic() start ...");

		super.funcId = CommonConst.FTZ_Add_210207;
		
		ResultMessages messages = ResultMessages.error();

//		ftzInTxnDtl.setReportCode(CommonConst.MSG_NO_210207);
...
//			
	...
	protected void updateTxnLogic(FtzInTxnDtl ftzInTxnDtl) {
		log.debug("FTZ210207ServiceImp.updateTxnLogic() start ...");
...
//		ftzInTxnDtl.setChkDatetime(DateUtil.getFormatDateTimeRemoveSpritAndColon(ftzInTxnDtl.getChkDatetime()));
	...
	protected void validateTxn(FtzInTxnDtl ftzInTxnDtl) {
		log.debug("FTZ210207ServiceImp.validateTxn() start ...");
...
//			ResultMessage msg = ResultMessage.fromCode("e.ftzmis.210207.0012");
//			messages.addAll(msg);
//		}
//	
