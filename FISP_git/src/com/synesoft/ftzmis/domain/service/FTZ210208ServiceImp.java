...
public class FTZ210208ServiceImp extends FTZInCommonServiceImp {
	...
	protected void addMsgLogic(FtzInMsgCtl ftzInMsgCtl) {
		log.debug("FTZ210208ServiceImp.addMsgLogic() start ...");
	...
	protected void addTxnLogic(FtzInTxnDtl ftzInTxnDtl) {
		log.debug("FTZ210208ServiceImp.addTxnLogic() start ...");

		super.funcId = CommonConst.FTZ_Add_210208;
		
		ResultMessages messages = ResultMessages.error();

//		ftzInTxnDtl.setReportCode(CommonConst.MSG_NO_210208);
...
//			
	...
	protected void updateTxnLogic(FtzInTxnDtl ftzInTxnDtl) {
		log.debug("FTZ210208ServiceImp.updateTxnLogic() start ...");
...
//		ftzInTxnDtl.setChkDatetime(DateUtil.getFormatDateTimeRemoveSpritAndColon(ftzInTxnDtl.getChkDatetime()));
	...
	protected void validateTxn(FtzInTxnDtl ftzInTxnDtl) {
		log.debug("FTZ210208ServiceImp.validateTxn() start ...");
...
//			ResultMessage msg = ResultMessage.fromCode("e.ftzmis.210208.0012");
//			messages.addAll(msg);
//		}
//	
