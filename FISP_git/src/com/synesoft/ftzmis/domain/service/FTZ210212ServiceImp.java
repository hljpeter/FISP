...
import com.synesoft.ftzmis.domain.repository.FTZ210212Repository;
...
public class FTZ210212ServiceImp implements FTZ210212Service {
	...
	public Page<FtzInMsgCtl> queryFtzInMsgCtlPageInput(Pageable pageable,
		...
		return ftz210212Repos.queryFtzInMsgCtlPageInput(pageable, ftzInMsgCtl);
	}

	@Override
	public Page<FtzInMsgCtl> queryFtzInMsgCtlPage(Pageable pageable,
			FtzInMsgCtl ftzInMsgCtl) {
		return ftz210212Repos.queryFtzInMsgCtlPage(pageable, ftzInMsgCtl);
	}

	@Override
	public Page<FtzInTxnDtl> queryFtzInTxnDtlPage(Pageable pageable,
			FtzInTxnDtl ftzInTxnDtl) {
		return ftz210212Repos.queryFtzInTxnDtlPage(pageable, ftzInTxnDtl);
	}

	@Override
	public FtzInTxnDtl queryFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		return ftz210212Repos.queryFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int deleteFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		...
		ftz210212Repos.deleteFtzInTxnDtls(ftzInTxnDtl);
		...
		int i = ftz210212Repos.deleteFtzInMsgCtl(ftzInMsgCtl);
		return i;
	}
	...
	public int insertFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		...
		return ftz210212Repos.insertFtzInMsgCtl(ftzInMsgCtl);
	}
	...
	public int updateFtzInMsgCtl(FtzInMsgCtl ftzInMsgCtl) {
		...
		return ftz210212Repos.updateFtzInMsgCtl(ftzInMsgCtl);
	}
	...
	public int deleteFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		...
		return ftz210212Repos.deleteFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public List<FtzActMstr> queryFtzActMstrs(FtzActMstr ftzActMstr) {
		return ftz210212Repos.queryFtzActMstrs(ftzActMstr);
	}

	@Override
	public List<FtzInTxnDtl> queryFtzInTxnDtlList(FtzInTxnDtl ftzInTxnDtl) {
		return ftz210212Repos.queryFtzInTxnDtlList(ftzInTxnDtl);
	}
	...
	public int insertFtzInTxnDtl(FtzInTxnDtl ftzInTxnDtl) {
		...
		FtzInMsgCtl result_FtzInMsgCtl = ftz210212Repos
		...
		ftz210212Repos.updateFtzInMsgCtl(update_FtzInMsgCtl);
		BizLog(CommonConst.DATA_LOG_OPERTYPE_ADD,"",ftzInTxnDtl.toString());
		return ftz210212Repos.insertFtzInTxnDtl(ftzInTxnDtl);
	}
	...
	public int updateFtzInTxnDtlSelective(FtzInTxnDtl ftzInTxnDtl) {
		...
		return ftz210212Repos.updateFtzInTxnDtlSelective(ftzInTxnDtl);
	}
	...
	public FtzBankCode queryFtzBankCode(FtzBankCode ftzBankCode) {
		return ftz210212Repos.queryFtzBankCode(ftzBankCode);
	}
	...
	@Autowired
	protected FTZ210212Repository ftz210212Repos;
