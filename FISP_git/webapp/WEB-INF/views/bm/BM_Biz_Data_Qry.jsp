<script type="text/javascript">
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/BM_Biz_Data_Qry/Qry";
		form.submit();
	}
	//detail button
	function detailSearch(id) {
		document.getElementById("sysDataId").value = id;
		window.showModalDialog('${pageContext.request.contextPath}/BM_Biz_Data_Qry/Init?sysChgBizLog.sysDataId='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	}
</script>
<!-- tips information -->
<div id="id_showMsg" style="display: none"> 
	...
	<div id="id_result">
		...
		<spring:hasBindErrors name="BM_Biz_DataForm">
			<form:form commandName="BM_Biz_DataForm">
...
<!-- title -->
<div class="page_title"><spring:message code="Title_BM_Biz_Data_Qry"/></div>
...
<div class="row">
    ...
    <div class="tbl_page_body"    >
      ...
      <form:form id="loanBalanceListForm" action="${pageContext.request.contextPath}" modelAttribute="loanBalanceForm">
      	<input id="sysDataId" type="hidden" name="sysChgBizLog.sysDataId"/>
...
<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
	<div class="leftPage">
		<util:pagination page="${page}" query="branchId=${BM_Biz_DataForm.branchId}
		&funcId=${BM_Biz_DataForm.funcId}&userId=${BM_Biz_DataForm.userId}&operType=${BM_Biz_DataForm.operType}&minOperDate=${BM_Biz_DataForm.minOperDate}
		&maxOperDate=${BM_Biz_DataForm.maxOperDate}&minOperTime=${BM_Biz_DataForm.minOperTime}&maxOperTime=${BM_Biz_DataForm.maxOperTime}&}" />
	</div>
</div>
