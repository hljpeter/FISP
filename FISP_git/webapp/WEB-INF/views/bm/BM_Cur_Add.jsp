<script type="text/javascript">
  	//modify button
		...
		form.action = "${pageContext.request.contextPath}/BM_Cur_Upd/Insert";
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.la.currencyAdd"/></div>
	...
	<form:form id="form" action="${pageContext.request.contextPath}/" method="post" modelAttribute="bm_Cur_QryForm" class="form-horizontal">
		...
		<table class="tbl_search">
	    	<tr>
				...
				<td>
					<form:input  id="currCode" path="currCode" type="text" class=".input-small" />		
				</td>
				<td class="label_td"><font color="red">*</font><spring:message code="index.label.bm.currLan"/>:</td>
				<td>
					<form:select id="currLan" path="currLan" class=".input-small">
						<form:option value=""/>
			...
			<tr>
			   <td class="label_td"><font color="red">*</font><spring:message code="index.label.bm.CurrName"/>:</td>
				<td colspan="3">	
					<form:input id="currName" path="currName" type="text" class="span5"  />
				</td>				
			</tr>
	    </table>								
	</form:form>
...
<div class="row">
	<div class="navbar navbar-fixed-bottom text-right" id="footer" style="margin-bottom:0px; line-height:30px; background-color: #eee; opacity:0.9;">
		<input type="button" id="confirmBtn" class="btn btn-primary" onclick="AddCur()" value="<spring:message code="button.lable.Submit"/>">
