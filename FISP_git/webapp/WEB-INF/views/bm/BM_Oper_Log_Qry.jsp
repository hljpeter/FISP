<script type="text/javascript">
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/BM_Oper_Log_Qry/Qry";
		form.submit();
	}
	//detail button
	function detailSearch(id) {
		document.getElementById("sysOperId").value = id;
		window.showModalDialog('${pageContext.request.contextPath}/BM_Oper_Log_Qry/Init?sysOperLog.sysOperId='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	}
</script>
<!-- tips information -->
<div id="id_showMsg" style="display: none"> 
	...
	<div id="id_result">
		...
		<spring:hasBindErrors name="BM_Oper_LogForm">
			<form:form commandName="BM_Oper_LogForm">
...
<!-- title -->
<div class="page_title"><spring:message code="Title_BM_Oper_Log_Qry"/></div>
	...
	<form:form id="form" action="${pageContext.request.contextPath}/" method="post" modelAttribute="BM_Oper_LogForm" class="form-horizontal">
		<table class="tbl_search">
	    	<tr>
				...
				<td colspan="2">
					<form:select path="funcName" class=".input-small">
						<form:option value=""/>
...
<div class="row">
      ...
      <thead>
       <tr>
        	...
        	<th class="tbl_page_th" width="100px"><spring:message code="label_BRANCH_NAME"/></th>
          	<th class="tbl_page_th" width="100px"><spring:message code="label_FUNC_NAME"/></th>
            ...
            <th class="tbl_page_th" width="60px"><spring:message code="label_OPER_TIME"/></th>
          	...
          	<th class="tbl_page_th" width="100px"><spring:message code="label_USER_IP"/></th>
    ...
    <div class="tbl_page_body"    >
      ...
      <form:form id="loanBalanceListForm" action="${pageContext.request.contextPath}" modelAttribute="loanBalanceForm">
      	<input id="sysOperId" type="hidden" name="sysOperLog.sysOperId"/>
        <c:forEach var="dto" items="${page.content}" varStatus="i">
          <tr>
            ...
            <td class="tbl_page_td_left vtip" width="100px">${dto.funcName }</td>
           ...
           <td class="tbl_page_td_left vtip" width="80px">
			...
			<td class="tbl_page_td_left vtip" width="50px">
           	...
           	<td class="tbl_page_td_left vtip" width="100px">${dto.userIp }</td>
            <td class="tbl_page_td_left" width="40px">
	           	<div align="center" style="height: 25px">
					<input type="button" id="detailBtn" class="btn btn-small" onclick="detailSearch('${f:h(dto.sysOperId)}')"value="<spring:message code="button.lable.DeatilSearch"/>">
               </div>
            </td>
          </tr>
        </c:forEach>
...
<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
	<div class="leftPage">
		<util:pagination page="${page}" query="branchId=${BM_Oper_LogForm.branchId}
		&funcName=${BM_Oper_LogForm.funcName}&userId=${BM_Oper_LogForm.userId}&operType=${BM_Oper_LogForm.operType}&minOperDate=${BM_Oper_LogForm.minOperDate}
		&maxOperDate=${BM_Oper_LogForm.maxOperDate}&minOperTime=${BM_Oper_LogForm.minOperTime}&maxOperTime=${BM_Oper_LogForm.maxOperTime}&}" />
	</div>
</div>
