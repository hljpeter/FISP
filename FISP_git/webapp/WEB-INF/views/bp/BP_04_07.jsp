...
window.name="curWindow";
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/bp04/07/search";
	...
	function detailSearch(id) {
		...
		window.showModalDialog('${pageContext.request.contextPath}/bp04/07/detailSearch?loanAmount.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	}
</script>
<!-- tips information -->
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.processedListLoanAmountDetailQuery"/></div>

<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/bp04/07/init" method="post" modelAttribute="loanAmountForm" class="form-horizontal">
      ...
      <thead>
        <tr>
        	<th class="tbl_page_th" width="20px">No.</th>
          	...
          	<th class="tbl_page_th" width="180px"><spring:message code="fisp.la.customerName"/></th>
...
<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
	<div class="leftPage">
		<util:pagination page="${page}" query="loanIouAmount=${loanAmountForm.loanAmount.loanIouAmount}&workDate=${loanAmountForm.loanAmount.workDate}
		&productType=${loanAmountForm.loanAmount.productType}&customerNo=${loanAmountForm.loanAmount.customerNo}&customerName=${loanAmountForm.loanAmount.customerName}" />
	</div>
</div>
