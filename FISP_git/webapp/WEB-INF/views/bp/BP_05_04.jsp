...
window.name="curWindow";
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/bp05/04/search";
	...
	function detailSearch(id) {
		...
		window.showModalDialog('${pageContext.request.contextPath}/bp05/05/detailSearch?depositBalance.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.processedListDepositBalanceAuthQuery"/></div>
        ...
        <tr>
          <th class="tbl_page_th" width="20px"><input id="allcheckbox" type="checkbox" ></th>
            <th class="tbl_page_th" width="20px">No.</th>
          	...
          	<th class="tbl_page_th" width="140px"><spring:message code="fisp.la.depositCustomerName"/></th>
            ...
            <th class="tbl_page_th" width="90px"><spring:message code="fisp.la.depositBalanceDis"/></th>
        ...
        <c:forEach var="dto" items="${page.content}" varStatus="i">
          <tr>
           <td class="vtip" align="center"  width="20px"><input type="checkbox" name="checkbox" ></td>
            ...
            <td class="tbl_page_td_right vtip" width="90px">
