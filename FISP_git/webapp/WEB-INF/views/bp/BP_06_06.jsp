<script type="text/javascript">
	...
	function input() {
		...
		form.action = "${pageContext.request.contextPath}/bp06/06/add";
...
<div class="row" style="margin-bottom: 40px;">
	<form:form id="form" action="${pageContext.request.contextPath}/bp06/06/init" method="post" modelAttribute="loanBalanceForm" class="form-horizontal">
