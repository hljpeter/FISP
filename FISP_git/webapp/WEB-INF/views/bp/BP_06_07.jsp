...
window.name="curWindow";
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/bp06/07/search";
	...
	function detailSearch(id) {
		...
		window.showModalDialog('${pageContext.request.contextPath}/bp06/07/detailSearch?loanBalance.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	}
</script>
<!-- tips information -->
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.processedListLoanBalanceDetailQuery"/></div>
...
<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
	<div class="leftPage">
		<util:pagination page="${page}" query="workDate=${loanBalanceForm.loanBalance.workDate}
		&loanIouBalance=${loanBalanceForm.loanBalance.loanIouBalance}&productType=${loanBalanceForm.loanBalance.productType}}" />
	</div>
</div>
