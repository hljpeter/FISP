<script type="text/javascript">
	...
	function input() {
		...
		form.action = "${pageContext.request.contextPath}/dp02/06/add";
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.DataManageDepositBalanceAdd"/></div>
<!-- body -->
<div class="row" style="margin-bottom: 40px;">
	<form:form id="form" action="${pageContext.request.contextPath}/dp02/06/init" method="post" modelAttribute="depositBalanceForm" class="form-horizontal">
