<!-- title -->
<div class="page_title"><spring:message code="fisp.title.DataQueryDepositBalanceQueryDetail"/></div>
<!-- body -->
<div class="row" style="margin-bottom: 40px;">
	<form:form id="form" action="${pageContext.request.contextPath}/dp02/07/detailSearch" method="post" modelAttribute="depositBalanceForm" class="form-horizontal">
