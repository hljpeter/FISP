<script type="text/javascript">
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/dp03/01/search";
		form.submit();
	}
	//detail button
	function detailSearch(id) {
		document.getElementById("loanAmountId").value = id;
		window.showModalDialog('${pageContext.request.contextPath}/dp03/01/detailSearch?loanAmount.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	}
</script>
<!-- tips information -->
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.loanAmountSearch"/></div>

<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/dp03/01/init" method="post" modelAttribute="loanAmountForm" class="form-horizontal">
