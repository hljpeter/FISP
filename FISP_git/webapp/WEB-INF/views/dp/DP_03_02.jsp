<script type="text/javascript">
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/dp03/02/search";
		form.submit();
	}
	//detail button
	function detailSearch(id) {
		document.getElementById("depositBalanceId").value = id;
		window.showModalDialog('${pageContext.request.contextPath}/dp03/02/detailSearch?depositBalance.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	}
</script>
<!-- tips information -->
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.depositBalanceQuery"/></div>

<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/dp03/02/init" method="post" modelAttribute="depositBalanceForm" class="form-horizontal">
