<script type="text/javascript">
	...
	function input() {
		...
		form.action = "${pageContext.request.contextPath}/dp04/02/modify";
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.DataManageLoanBalanceInput"/></div>
<!-- body -->
<div class="row" style="margin-bottom: 40px;">
	<form:form id="form" action="${pageContext.request.contextPath}/dp04/02/search" method="post" modelAttribute="loanBalanceForm" class="form-horizontal">
