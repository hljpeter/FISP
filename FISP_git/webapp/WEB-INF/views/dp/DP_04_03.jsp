<!-- title -->
<div class="page_title"><spring:message code="fisp.title.DataManageLoanBalanceInputDetailQuery"/></div>
<!-- body -->
<div class="row" style="margin-bottom: 40px;">
	<form:form id="form" action="${pageContext.request.contextPath}/dp04/03/detailSearch" method="post" modelAttribute="loanBalanceForm" class="form-horizontal">
