...
$(function() {
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/dp07/01/search";
		form.submit();
	}

	//detail button
	function detailSearch() {
		window.location.href="${pageContext.request.contextPath}/dp03/03/init";
	}
...
<div id="id_showMsg" style="display: none"> 
	...
	<div id="id_result">
		...
		<spring:hasBindErrors name="loanBalanceCheckForm">
			<form:form commandName="loanBalanceCheckForm">
...
<!-- title -->
<div class="page_title">数据管理 / 数据核对 / 贷款余额核对</div>

<!-- body -->
<div class="row"><form:form id="form" method="post" action="${pageContext.request.contextPath}/dp07/01/init"
	modelAttribute="loanBalanceCheckForm" class="form-horizontal">
		...
		<form:form id="impFileCfgForm" action="${pageContext.request.contextPath}"
			...
			<c:forEach var="dto" items="${page.content}" varStatus="i">
				<tr>
					...
					<td class="tbl_page_td_left vtip"  align="center"  width="150px">${dto.productName}</td>
