<script type="text/javascript">
	$(function() {
		...
		$("#pageTable").find("tr").bind(
				...
				function() {
					...
					var selected_seqNo = $(this).find("td:eq(9)").text();
					showDialog(
							'${pageContext.request.contextPath}/FTZ210101/QryAuthDtlDtl?selected_msgId='
	...
	function queryFTZ210101Dtl() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210101/QryAuthDtl?page.page="+ ${page.number + 1};
		form.submit();
	}
	function sbDtl() {
		...
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210101/AuthDtlSubmit";
		form.submit();
	}
	function BalanceValidation(){
		//	$("#check_AccountNo").val($("#accountNo").val());
		//	$("#check_SubAccountNo").val($("#subAccountNo").val());
		//	$("#check_SubmitDate").val($("#submitDate").val());
		//	var form = document.getElementById("form");
		//	form.action = "${pageContext.request.contextPath}/FTZINCOM/BalanceCheck";	
		//	form.submit();	
...
<div class="page_title">
	<spring:message code="ftzmis.title.210101.auth.dtl" />
</div>
	...
	<form:form id="form"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td><form:input id="currency" path="ftzInMsgCtl.currency"
						class=".input-large" readonly="true" /></td>
				<td class="label_td"><spring:message
...
<div class="row" style="margin-bottom: 40px;">
	<div class="navbar navbar-fixed-bottom text-center" id="footer"
		...
		<input id="detaildetail" type="button" class="btn btn-primary"
			...
			value="<spring:message code="ftz.label.balanceValidation"/>"><input
