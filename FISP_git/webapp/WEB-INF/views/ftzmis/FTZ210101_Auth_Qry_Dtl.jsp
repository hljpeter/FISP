<script type="text/javascript">
		...
		.bind(
				...
				function() {
					...
					var selected_seqNo = $(this).find("td:eq(9)")
							.text();
					showDialog('${pageContext.request.contextPath}/FTZ210101/QryAuthDtlDtl?selected_msgId='
							+ selected_msgId
							+ "&selected_seqNo="
	...
	function queryFTZ210101Dtl() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210101/QryAuthDtl";
		form.submit();
	}
	function sbDtl() {
		$("#selected_msgId").val($("#msgId").val());
...
<div class="page_title"><spring:message code="ftzmis.title.210101.auth.dtl" /></div>
