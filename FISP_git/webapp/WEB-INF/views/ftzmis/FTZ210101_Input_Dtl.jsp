<script type="text/javascript">
	$(function() {
		...
		if ('add' == input_flag) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210101/AddDtlSubmit";
		} else if ('upt' == input_flag) {
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210101/UptDtlSubmit";
		}
	...
	function addRef() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210101/AddDtlInit";
		form.submit();
	}
	...
	function delDetailDtl() {
		...
		if (null == selected_seqNo || "" == selected_seqNo) {
			...
			$("#balance").val($("#balance").val().replaceAll(",", ""));
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210101/InputDtlDel";
...
<div class="page_title">
	<spring:message code="ftzmis.title.210101.input.dtl" />
</div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210101/UptDtlSubmit"
		...
		<table class="tbl_search">
			<tr>
				...
				<td><form:hidden path="ftzInMsgCtl.branchId" id="branchId1" />
					<form:select id="branchId" path="ftzInMsgCtl.branchId"
						disabled="true">
			...
			<tr>
				<td class="label_td"><font color="red">*</font> <spring:message
						code="ftz.label.ACC_TYPE" />：</td>
				<td><form:hidden path="ftzInMsgCtl.accType" id="accType1" /> <form:select
						id="accType" path="ftzInMsgCtl.accType" disabled="true">
						<form:option value=""></form:option>
			...
			<tr>
				<td class="label_td"><spring:message
						code="ftz.label.DEPOSIT_RATE" />：</td>
				<td><t:moneyFormat type="text" id="depositRate"
						name="ftzInMsgCtl.depositRate"
						value="${FTZ210101Form.ftzInMsgCtl.depositRate}"
						format="###.000000" dot="true" readonly="true" /></td>
				<td class="label_td"><font color="red">*</font> <spring:message
						code="ftz.label.CUSTOM_TYPE" />：</td>
				<td><form:hidden path="ftzInMsgCtl.customType" id="customType1" />
					<form:select id="customType" path="ftzInMsgCtl.customType"
						disabled="true">
						<form:option value=""></form:option>
			...
			<tr>
				...
				<td class="label_td"><font color="red">*</font> <spring:message
						code="ftz.label.DOCUMENT_TYPE" />：</td>
				<td><form:hidden path="ftzInMsgCtl.documentType"
						id="documentType1" /> <form:select id="documentType"
						path="ftzInMsgCtl.documentType" disabled="true">
						<form:option value=""></form:option>
			...
			<tr>
				...
				<td><t:moneyFormat type="text" id="balance"
						...
						value="${FTZ210101Form.ftzInMsgCtl.balance}"
...
<div class="pagination pull-right" style="margin-top: 10px;">
	<div class="rightPage">
		<util:pagination page="${page}"
			query="selected_msgId=${FTZ210101Form.ftzInMsgCtl.msgId}"
			action="${pageUrl}" />
	</div>
</div>
