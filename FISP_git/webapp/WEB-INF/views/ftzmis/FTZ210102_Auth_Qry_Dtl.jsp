<script type="text/javascript">
				...
				.bind(
						...
						function() {
							...
							var selected_seqNo = $(this).find("td:eq(9)")
									.text();
							showDialog('${pageContext.request.contextPath}/FTZ210102/QryAuthDtlDtl?selected_msgId='
									+ selected_msgId
									+ "&selected_seqNo="
	...
	function queryFTZ210102Dtl() {
		$("#selected_msgId").val($("#msgId").val());
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210102/QryAuthDtl?page.page="+${page.number+1};
		form.submit();
	}
	function sbDtl() {
		$("#selected_msgId").val($("#msgId").val());
...
<div class="page_title">
	<spring:message code="ftzmis.title.210102.auth.dtl" />
</div>
...
<div class="pagination pull-right" style="margin-top: 10px;">
	<div class="rightPage">
		<util:pagination page="${page}"
			query="selected_msgId=${FTZ210102Form.ftzInMsgCtl.msgId}" />
	</div>
</div>
