...
function authPass() {
	...
	$("#issueAmount").val($("#issueAmount").val().replaceAll(",",""));
	var form = document.getElementById("form");
	form.action = "${pageContext.request.contextPath}/FTZ210102/AuthDtlDtlSubmit?authStat=1";
	form.submit();
}
...
function authRefuse() {
	...
	$("#issueAmount").val($("#issueAmount").val().replaceAll(",",""));
	var form = document.getElementById("form");
	form.action = "${pageContext.request.contextPath}/FTZ210102/AuthDtlDtlSubmit?authStat=0";
	form.submit();
}
...
<div class="page_title"><spring:message code="ftzmis.title.210102.auth.dtl.dtl" /></div>
	...
	<form:form id="form"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td>
				<t:moneyFormat type="text" id="amount"
				...
				<td>
				<t:moneyFormat type="text" id="issueAmount"
			...
			<tr>
				...
				<td class="label_td"><spring:message code="ftz.label.INTEREST_RATESS" />：</td>
