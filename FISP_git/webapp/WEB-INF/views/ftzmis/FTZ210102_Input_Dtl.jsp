<script type="text/javascript">
	$(function() {
		...
		if ('add' == input_flag) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210102/AddDtlSubmit";
	...
	function addRef() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210102/AddDtlInit";
		form.submit();
	}
	...
	function delDetailDtl() {
		...
		if (null == selected_seqNo || "" == selected_seqNo) {
			...
			$("#balance").val($("#balance").val().replaceAll(",", ""));
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210102/InputDtlDel";
	...
	function addDetailDtl() {
		var selected_msgId = $("#msgId").val();
		showDialog('${pageContext.request.contextPath}/FTZ210102/AddDtlDtlInit?selected_msgId='
	...
	function uptDetailDtl() {
		...
		if (null == selected_seqNo || "" == selected_seqNo) {
			...
			showDialog('${pageContext.request.contextPath}/FTZ210102/UptDtlDtlInit?selected_msgId='
					+ selected_msgId + "&selected_seqNo="
					+ selected_seqNo,'500','1024');
			queryFTZ210102();
		}
	...
	function queryFTZ210102() {
		...
		$("#balance").val($("#balance").val().replaceAll(",", ""));
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210102/DtlInitReflash?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210102.input.dtl" />
</div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210102/UptDtlSubmit"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<form:select path="ftzInMsgCtl.msgStatus" disabled="true">
						<form:option value=""></form:option>
			...
			<tr>
				...
				<input type="hidden" id="subAccountNo"
					name="ftzInMsgCtl.subAccountNo" >	
				
				</td>
				<td class="label_td"><font color="red">*</font>
				<spring:message code="ftz.label.ACC_TYPE" />：</td>
			...
			<tr>
				...
				<td class="label_td"><font color="red">*</font>
				<spring:message code="ftz.label.ACC_ORG_CODE" />：</td>
				<td><form:input id="accOrgCode" path="ftzInMsgCtl.accOrgCode"
						class=".input-large" readonly="true" /></td>
			</tr>
			
			<c:if test="${ FTZ210102Form.input_flag eq 'upt'}">
...
<div class="pagination pull-right" style="margin-top: 10px;">
	<div class="rightPage">
		<util:pagination page="${page}"
			query="selected_msgId=${FTZ210102Form.ftzInMsgCtl.msgId}" action="${pageUrl}"/>
	</div>
</div>
