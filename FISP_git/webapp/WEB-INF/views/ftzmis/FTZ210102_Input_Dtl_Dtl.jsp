<script type="text/javascript">
	...
	function addDetail() {
		...
		var input_Dtl_flag = $("#input_Dtl_flag").val();
		if ('add' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210102/AddDtlDtlSubmit";
		} else if ('upt' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210102/UptDtlDtlSubmit";
		}
		form.submit();
	}
	...
	function addRef() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210102/AddDtlDtlInit";
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210102.input.dtl.dtl" />
</div>
	...
	<form:form id="form"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td class="label_td"><font color="red">*</font> <spring:message
						code="ftz.label.ISSUE_AMOUNT" />：</td>
				<td><t:moneyFormat type="text" id="issueAmount"
						value="${FTZ210102Form.ftzInTxnDtl.issueAmount}"
						format="###,###,###,###.00" dot="true"
						name="ftzInTxnDtl.issueAmount" maxlength="24" /></td>
			</tr>
			<tr>
				<td class="label_td"><font color="red">*</font> <spring:message
...
<form:form id="form1" modelAttribute="FTZ210102Form" method="post">
