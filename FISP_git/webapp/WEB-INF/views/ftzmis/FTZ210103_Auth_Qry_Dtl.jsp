<script type="text/javascript">
				...
				.bind(
						...
						function() {
							...
							var selected_seqNo = $(this).find("td:eq(11)")
									.text();
							showDialog('${pageContext.request.contextPath}/FTZ210103/QryAuthDtlDtl?selected_msgId='
									+ selected_msgId
									+ "&selected_seqNo="
	...
	function queryFTZ210103Dtl() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210103/QryAuthDtl?page.page="+${page.number+1};
		form.submit();
	}
	function sbDtl() {
		$("#selected_msgId").val($("#msgId").val());
		...
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210103/AuthDtlSubmit";
		form.submit();
	}
...
<div class="page_title">
	<spring:message code="ftzmis.title.210103.auth.dtl" />
</div>
