<script type="text/javascript">
				...
				.bind(
						...
						function() {
							var selected_msgId = $(this).find("td:eq(3)")
									.text();
							showDialog('${pageContext.request.contextPath}/FTZ210103/QryDtl?selected_msgId='
	...
	function sbDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210103/SubmitDtl";
	...
	function delDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210103/InputDel";
	...
	function addDetail() {
		showDialog('${pageContext.request.contextPath}/FTZ210103/AddDtlInit','500','1024');
		queryFTZ210103();
	}
	function uptDetail() {
		var selected_msgId = $("#selected_msgId").val();
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			if ("01" == selected_msgType || "04" == selected_msgType
					|| "02" == selected_msgType) {
				showDialog('${pageContext.request.contextPath}/FTZ210103/UptDtlInit?selected_msgId='
						+ selected_msgId,'500','1024');
				queryFTZ210103();
			} else {
	...
	function queryFTZ210103() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210103/AddQry?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210103.input" />
</div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210103/AddQry"
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210103Form.query_branchId}&query_submitDate_start=${FTZ210103Form.query_submitDate_start}&query_submitDate_end=${FTZ210103Form.query_submitDate_end}&query_msgId=${FTZ210103Form.query_msgId}&query_accountNo=${FTZ210103Form.query_accountNo}&query_msgStatus=${FTZ210103Form.query_msgStatus}"
								action="/FTZ210103/AddQry" /></td>
					</tr>
				</table>
			</td>
		</tr>
