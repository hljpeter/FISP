<script type="text/javascript">
	$(function() {
		...
		$("#pageTable").find("tr").bind(
				...
				function() {
					...
					var selected_seqNo = $(this).find("td:eq(9)").text();
					showDialog(
							'${pageContext.request.contextPath}/FTZ210104/QryDtlDtl?selected_msgId='
	...
	function queryFTZ210104Dtl() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210104/QryDtl";
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210104.qry.dtl" />
</div>
