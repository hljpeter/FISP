<script type="text/javascript">
	...
	function sbDtl() {
		...
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210105/AuthDtlSubmit";
		form.submit();
	}
...
<div class="page_title">
	<spring:message code="ftzmis.title.210105.auth.dtl" />
</div>
...
<div class="pagination pull-right" style="margin-top: 10px;">
	<div class="rightPage">
		<util:pagination page="${page}"
			query="selected_msgId=${FTZ210105Form.ftzInMsgCtl.msgId}" />
	</div>
</div>
