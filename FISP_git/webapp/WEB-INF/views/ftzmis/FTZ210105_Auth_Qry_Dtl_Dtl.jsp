<script type="text/javascript">
	...
	function authPass() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210105/AuthDtlDtlSubmit?authStat=1";
		form.submit();
	}

	function authRefuse() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210105/AuthDtlDtlSubmit?authStat=0";
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210105.auth.dtl.dtl" />
</div>
	...
	<form:form id="form"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<spring:message code="ftz.label.TERM_LENGTH1" />：</td>
				<td><form:input id="termLength" path="ftzInTxnDtl.termLength"
						class=".input-large" readonly="true" /></td>
				<td class="label_td"><font color="red">*</font>
				<spring:message code="ftz.label.TERM_UNIT1" />：</td>
