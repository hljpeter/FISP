<script type="text/javascript">
	$(function() {
		...
		if ('add' == input_flag) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210105/AddDtlSubmit";
		} else if ('upt' == input_flag) {
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210105/UptDtlSubmit";
		}
	...
	function addRef() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210105/AddDtlInit";
		form.submit();
	}
	...
	function delDetailDtl() {
		...
		if (null == selected_seqNo || "" == selected_seqNo) {
			...
			$("#balance").val($("#balance").val().replaceAll(",", ""));
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210105/InputDtlDel";
	...
	function addDetailDtl() {
		var selected_msgId = $("#msgId").val();
		showDialog('${pageContext.request.contextPath}/FTZ210105/AddDtlDtlInit?selected_msgId='
...
<div class="page_title">
	<spring:message code="ftzmis.title.210105.input.dtl" />
</div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210105/UptDtlSubmit"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td><t:moneyFormat type="text" id="balance"
						...
						value="${FTZ210105Form.ftzInMsgCtl.balance}"
...
<div class="pagination pull-right" style="margin-top: 10px;">
	<div class="rightPage">
		<util:pagination page="${page}"
			query="selected_msgId=${FTZ210105Form.ftzInMsgCtl.msgId}"  action="${pageUrl}"/>
	</div>
</div>
