<script type="text/javascript">
				...
				.bind(
						...
						function() {
							var selected_msgId = $(this).find("td:eq(3)")
									.text();
							showDialog('${pageContext.request.contextPath}/FTZ210105/QryDtl?selected_msgId='
	...
	function sbDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210105/SubmitDtl";
	...
	function delDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210105/InputDel";
	...
	function addDetail() {
		showDialog('${pageContext.request.contextPath}/FTZ210105/AddDtlInit','500','1024');
		queryFTZ210105();
	}
	function uptDetail() {
		var selected_msgId = $("#selected_msgId").val();
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			if ("01" == selected_msgType || "04" == selected_msgType
					|| "02" == selected_msgType) {
				showDialog('${pageContext.request.contextPath}/FTZ210105/UptDtlInit?selected_msgId='
						+ selected_msgId,'500','1024');
				queryFTZ210105();
			} else {
	...
	function queryFTZ210105() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210105/AddQry?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210105.input" />
</div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210105/AddQry"
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210105Form.query_branchId}&query_submitDate_start=${FTZ210105Form.query_submitDate_start}&query_submitDate_end=${FTZ210105Form.query_submitDate_end}&query_msgId=${FTZ210105Form.query_msgId}&query_accountNo=${FTZ210105Form.query_accountNo}&query_msgStatus=${FTZ210105Form.query_msgStatus}"
								action="/FTZ210105/AddQry" /></td>
					</tr>
				</table>
			</td>
		</tr>
