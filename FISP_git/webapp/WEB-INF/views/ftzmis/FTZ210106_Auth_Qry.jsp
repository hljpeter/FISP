...
<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210106/AuthQry"
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210106Form.query_branchId}&query_submitDate_start=${FTZ210106Form.query_submitDate_start}&query_submitDate_end=${FTZ210106Form.query_submitDate_end}&query_msgId=${FTZ210106Form.query_msgId}&query_msgNo=${FTZ210106Form.query_msgNo}&query_accountNo=${FTZ210106Form.query_accountNo}"
								action="/FTZ210106/AuthQry" /></td>
					</tr>
				</table>
			</td>
		</tr>
