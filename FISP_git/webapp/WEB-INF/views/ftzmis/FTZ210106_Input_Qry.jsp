<script type="text/javascript">
	...
	function sbDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210106/SubmitDtl";
...
<div class="page_title"><spring:message code="ftzmis.title.210106.input" /></div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210106/AddQry"
		...
		<table class="tbl_search">
			<tr>
				<td class="label_td"><spring:message code="ftz.label.BRANCH_IDS" />：</td>
				<td><form:select path="query_branchId">
						<form:option value=""></form:option>
						<form:options items="${SM_0002}" />
					</form:select></td>
				<td class="label_td"><spring:message code="ftz.label.SUBMIT_DATES" />：</td>
			...
			<td width="50%" align="right">
				<table>
					...
					<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210106Form.query_branchId}&query_submitDate_start=${FTZ210106Form.query_submitDate_start}&query_submitDate_end=${FTZ210106Form.query_submitDate_end}&query_msgId=${FTZ210106Form.query_msgId}&query_accountNo=${FTZ210106Form.query_accountNo}&query_msgStatus=${FTZ210106Form.query_msgStatus}"
								action="/FTZ210106/AddQry" /></td>
					</tr>
				</table>
			</td>
		</tr>
