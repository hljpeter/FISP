<script type="text/javascript">
				...
				.bind(
						...
						function() {
							...
							var selected_seqNo = $(this).find("td:eq(12)")
									.text();
							showDialog('${pageContext.request.contextPath}/FTZ210107/QryAuthDtlDtl?selected_msgId='
									+ selected_msgId
									+ "&selected_seqNo="
	...
	function queryFTZ210107Dtl() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210107/QryAuthDtl?page.page="+${page.number+1};
		form.submit();
	}
	...
	function sbDtl() {
		...
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210107/AuthDtlSubmit";
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210107.auth.dtl" />
</div>
				...
				<c:forEach var="dto1" items="${page.content}" varStatus="i">
					<tr>
						...
						<td class="vtip" style="text-align: left; width: 50px;"><t:codeValue
								...
								type="label" /></td>
						<td class="vtip" style="text-align: left; width: 30px;">${dto1.termLength}</td>
						<td class="vtip" style="text-align: left; width: 30px;"><t:codeValue
								items="${FTZ_REBUY_TERM_UNIT}" key="${dto1.termUnit}"
								type="label" /></td>
						<td class="vtip" style="text-align: left; width: 40px;">${dto1.valueDate}</td>
						<td class="vtip" style="text-align: left; width: 40px;">${dto1.expireDate}</td>
						<td class="vtip" style="text-align: left; width: 40px;"><t:moneyFormat
...
<div class="row" style="margin-bottom: 40px;">
	<div class="navbar navbar-fixed-bottom text-center" id="footer"
		...
		<input id="detaildetail" type="button" class="btn btn-primary"
			...
			value="<spring:message code="ftz.label.AUTH_MSG"/>"><input id="balanceValidation" type="button" class="btn btn-primary"
