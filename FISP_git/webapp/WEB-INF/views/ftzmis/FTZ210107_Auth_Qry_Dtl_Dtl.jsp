...
function authPass() {
	...
	form.action = "${pageContext.request.contextPath}/FTZ210107/AuthDtlDtlSubmit?authStat=1";
	form.submit();
}

function authRefuse() {
	var form = document.getElementById("form");
	form.action = "${pageContext.request.contextPath}/FTZ210107/AuthDtlDtlSubmit?authStat=0";
	form.submit();
}
...
<div class="page_title"><spring:message code="ftzmis.title.210107.auth.dtl.dtl" /></div>
	...
	<form:form id="form"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td><form:input id="expireDate" path="ftzInTxnDtl.expireDate"
						class=".input-large" readonly="true" /></td>
			</tr>
