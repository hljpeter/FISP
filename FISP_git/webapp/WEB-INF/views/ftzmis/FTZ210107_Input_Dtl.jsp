<script type="text/javascript">
	$(function() {
		...
		if ('add' == input_flag) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210107/AddDtlSubmit";
		} else if ('upt' == input_flag) {
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210107/UptDtlSubmit";
		}
		...
		$("#pageTable").find("tr").bind(
				...
				function() {
					...
					var selected_seqNo = $(this).find("td:eq(12)").text();
					showDialog(
							'${pageContext.request.contextPath}/FTZ210107/QryDtlDtl?selected_msgId='
	...
	function addRef() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210107/AddDtlInit";
		form.submit();
	}
	...
	function delDetailDtl() {
		...
		if (null == selected_seqNo || "" == selected_seqNo) {
			...
			$("#balance").val($("#balance").val().replaceAll(",", ""));
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210107/InputDtlDel";
	...
	function addDetailDtl() {
		var selected_msgId = $("#msgId").val();
		showDialog(
				'${pageContext.request.contextPath}/FTZ210107/AddDtlDtlInit?selected_msgId='
	...
	function uptDetailDtl() {
		...
		if (null == selected_seqNo || "" == selected_seqNo) {
			...
			showDialog(
					'${pageContext.request.contextPath}/FTZ210107/UptDtlDtlInit?selected_msgId='
							+ selected_msgId + "&selected_seqNo="
							+ selected_seqNo, '500', '1024');
			queryFTZ210107();
		}
	...
	function queryFTZ210107() {
		...
		$("#balance").val($("#balance").val().replaceAll(",", ""));
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210107/DtlInitReflash?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210107.input.dtl" />
</div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210107/UptDtlSubmit"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td><form:input id="accountNo" path="ftzInMsgCtl.accountNo"
					...
					</button> <form:hidden path="ftzInMsgCtl.subAccountNo" id="subAccountNo" /></td>
				<td class="label_td"><spring:message
			...
			<c:if test="${ FTZ210107Form.input_flag eq 'upt'}">
