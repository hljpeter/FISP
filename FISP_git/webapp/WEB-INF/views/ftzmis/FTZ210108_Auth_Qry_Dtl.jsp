<script type="text/javascript">
	...
	function queryFTZ210108Dtl() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210108/QryAuthDtl?page.page="+${page.number+1};
		form.submit();
	}
	function sbDtl() {
		$("#selected_msgId").val($("#msgId").val());
		...
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210108/AuthDtlSubmit";
		form.submit();
	}
		...
		<table
			...
			<thead>
				...
				<tr>
					...
					<th style="vertical-align: middle; text-align: center"
						width="130px"><spring:message code="ftz.label.OPP_NAME2" /></th>
...
<div class="pagination pull-right" style="margin-top: 10px;">
	<div class="rightPage">
		<util:pagination page="${page}"
			query="selected_msgId=${FTZ210108Form.ftzInMsgCtl.msgId}" />
	</div>
</div>
