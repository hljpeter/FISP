<script type="text/javascript">
	...
	function authPass() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210108/AuthDtlDtlSubmit?authStat=1";
		form.submit();
	}

	function authRefuse() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210108/AuthDtlDtlSubmit?authStat=0";
		form.submit();
	}
</script>
