<script type="text/javascript">
				...
				.bind(
						...
						function() {
							var selected_msgId = $(this).find("td:eq(3)")
									.text();
							showDialog('${pageContext.request.contextPath}/FTZ210108/QryDtl?selected_msgId='
	...
	function sbDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210108/SubmitDtl";
	...
	function delDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210108/InputDel";
	...
	function addDetail() {
		showDialog('${pageContext.request.contextPath}/FTZ210108/AddDtlInit','500','1024');
		queryFTZ210108();
	}
	function uptDetail() {
		var selected_msgId = $("#selected_msgId").val();
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			if ("01" == selected_msgType || "04" == selected_msgType
					|| "02" == selected_msgType) {
				showDialog('${pageContext.request.contextPath}/FTZ210108/UptDtlInit?selected_msgId='
						+ selected_msgId,'500','1024');
				queryFTZ210108();
			} else {
	...
	function queryFTZ210108() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210108/AddQry?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div id="id_showMsg" style="display: none">
	...
	<div id="id_result">
		<t:messagePanel />
		<spring:hasBindErrors name="FTZ210108Form">
			<form:form commandName="FTZ210108Form">
...
<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210108/AddQry"
		method="post" modelAttribute="FTZ210108Form" class="form-horizontal">
				...
				<c:forEach var="dto" items="${page.content}" varStatus="i">
					<tr>
						...
						<td class="vtip" style="text-align: left; width: 50px;"><t:codeValue
								items="${SYS_CURRENCY}" key="${dto.currency}"
								type="label" /></td>
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210108Form.query_branchId}&query_submitDate_start=${FTZ210108Form.query_submitDate_start}&query_submitDate_end=${FTZ210108Form.query_submitDate_end}&query_msgId=${FTZ210108Form.query_msgId}&query_accountNo=${FTZ210108Form.query_accountNo}&query_msgStatus=${FTZ210108Form.query_msgStatus}"
								action="/FTZ210108/AddQry" /></td>
					</tr>
				</table>
			</td>
		</tr>
