<script type="text/javascript">
				...
				.bind(
						...
						function() {
							...
							var selected_seqNo = $(this).find("td:eq(9)")
									.text();
							showDialog('${pageContext.request.contextPath}/FTZ210109/QryAuthDtlDtl?selected_msgId='
									+ selected_msgId
									+ "&selected_seqNo="
	...
	function queryFTZ210109Dtl() {
		$("#selected_msgId").val($("#msgId").val());
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210109/QryAuthDtl?page.page="+${page.number+1};
		form.submit();
	}
	...
	function sbDtl() {
		...
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210109/AuthDtlSubmit";
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210109.auth.dtl" />
</div>
...
<div class="pagination pull-right" style="margin-top: 10px;">
	<div class="rightPage">
		<util:pagination page="${page}"
			query="selected_msgId=${FTZ210109Form.ftzInMsgCtl.msgId}" />
	</div>
</div>
