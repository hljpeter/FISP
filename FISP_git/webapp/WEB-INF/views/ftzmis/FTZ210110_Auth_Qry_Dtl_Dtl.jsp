...
function authPass() {
	...
	form.action = "${pageContext.request.contextPath}/FTZ210110/AuthDtlDtlSubmit?authStat=1";
	form.submit();
}

function authRefuse() {
	var form = document.getElementById("form");
	form.action = "${pageContext.request.contextPath}/FTZ210110/AuthDtlDtlSubmit?authStat=0";
	form.submit();
}
...
<div class="page_title"><spring:message code="ftzmis.title.210110.auth.dtl.dtl" /></div>
