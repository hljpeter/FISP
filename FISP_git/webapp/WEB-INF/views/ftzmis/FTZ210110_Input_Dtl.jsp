<script type="text/javascript">
	$(function() {
		...
		if ('add' == input_flag) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210110/AddDtlSubmit";
		} else if ('upt' == input_flag) {
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210110/UptDtlSubmit";
		}
				...
				.bind(
						...
						function() {
							...
							var selected_seqNo = $(this).find("td:eq(12)")
									.text();
							showDialog('${pageContext.request.contextPath}/FTZ210110/QryDtlDtl?selected_msgId='
									+ selected_msgId
									+ "&selected_seqNo="
	...
	function addRef() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210110/AddDtlInit";
		form.submit();
	}
	...
	function delDetailDtl() {
		...
		if (null == selected_seqNo || "" == selected_seqNo) {
			...
			$("#balance").val($("#balance").val().replaceAll(",", ""));
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210110/InputDtlDel";
	...
	function addDetailDtl() {
		var selected_msgId = $("#msgId").val();
		showDialog('${pageContext.request.contextPath}/FTZ210110/AddDtlDtlInit?selected_msgId='
	...
	function uptDetailDtl() {
		...
		if (null == selected_seqNo || "" == selected_seqNo) {
			...
			showDialog('${pageContext.request.contextPath}/FTZ210110/UptDtlDtlInit?selected_msgId='
					+ selected_msgId + "&selected_seqNo="
					+ selected_seqNo,'500','1024');
			queryFTZ210110();
		}
	...
	function queryFTZ210110() {
		...
		$("#balance").val($("#balance").val().replaceAll(",", ""));
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210110/DtlInitReflash?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210110.input.dtl" />
</div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210110/UptDtlSubmit"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td><t:moneyFormat type="text" id="balance"
						...
						value="${FTZ210110Form.ftzInMsgCtl.balance}"
			...
			<c:if test="${ FTZ210110Form.input_flag eq 'upt'}">
...
<div class="pagination pull-right" style="margin-top: 10px;">
	<div class="rightPage">
		<util:pagination page="${page}"
			query="selected_msgId=${FTZ210110Form.ftzInMsgCtl.msgId}"  action="${pageUrl}"/>
	</div>
</div>
