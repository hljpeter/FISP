<script type="text/javascript">
	...
	function addDetail() {
		...
		var input_Dtl_flag = $("#input_Dtl_flag").val();
		if ('add' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210111/AddDtlDtlSubmit";
		} else if ('upt' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210111/UptDtlDtlSubmit";
		}
		form.submit();
	}
	...
	function addRef() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210111/AddDtlDtlInit";
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210111.input.dtl.dtl" />
</div>
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td colspan="3"><t:moneyFormat type="text" id="amount"
						...
						value="${FTZ210111Form.ftzInTxnDtl.amount}"
			...
			<tr>
				...
				<td><t:moneyFormat type="text" id="interestRate"
						...
						value="${FTZ210111Form.ftzInTxnDtl.interestRate}"
...
<form:form id="form1" modelAttribute="FTZ210111Form" method="post">
