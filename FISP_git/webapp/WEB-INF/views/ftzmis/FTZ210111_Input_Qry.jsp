<script type="text/javascript">
				...
				.bind(
						...
						function() {
							var selected_msgId = $(this).find("td:eq(3)")
									.text();
							showDialog('${pageContext.request.contextPath}/FTZ210111/QryDtl?selected_msgId='
	...
	function sbDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210111/SubmitDtl";
	...
	function delDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210111/InputDel";
	...
	function addDetail() {
		showDialog('${pageContext.request.contextPath}/FTZ210111/AddDtlInit','500','1024');
		queryFTZ210111();
	}
	function uptDetail() {
		var selected_msgId = $("#selected_msgId").val();
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			if ("01" == selected_msgType || "04" == selected_msgType
					|| "02" == selected_msgType) {
				showDialog('${pageContext.request.contextPath}/FTZ210111/UptDtlInit?selected_msgId='
						+ selected_msgId,'500','1024');
				queryFTZ210111();
			} else {
	...
	function queryFTZ210111() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210111/AddQry?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210111.input" />
</div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210111/AddQry"
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210111Form.query_branchId}&query_submitDate_start=${FTZ210111Form.query_submitDate_start}&query_submitDate_end=${FTZ210111Form.query_submitDate_end}&query_msgId=${FTZ210111Form.query_msgId}&query_accountNo=${FTZ210111Form.query_accountNo}&query_msgStatus=${FTZ210111Form.query_msgStatus}"
								action="/FTZ210111/AddQry" /></td>
					</tr>
				</table>
			</td>
		</tr>
