	...
	<form:form id="form"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td>
					<form:select id="personIdType" path="" ><!-- wpp -->
						<form:option value="" />
				...
				<td>
					<form:input id="personIdNo" path="" type="text" class=".input-small"/>
				</td>
			</tr>
			<tr>
				<td class="label_td"><font color="red">* </font><spring:message
							code="ftz.label.LOAN_TYPE" />:</td><!-- wpp2 -->
				<td><form:select path="ftzInTxnDtl.loanType" id="loanType">
					<form:option value=""></form:option>
				...
				<td>
					<form:input id="" path="" type="text" class=".input-small"/>
				</td>
			</tr>
			<tr>
				<td class="label_td"><spring:message
