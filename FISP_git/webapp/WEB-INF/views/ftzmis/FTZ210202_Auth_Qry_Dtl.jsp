<script type="text/javascript">
	...
	function sbDtl() {
		...
		$("#balance").val($("#balance").val().replaceAll(",", ""));
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210202/AuthDtlSubmit";
		form.submit();
	}
</script>
...
<div class="page_title"><spring:message code="ftzmis.title.210202.auth.dtl" /></div>
			...
			class="table table-striped table-bordered table-condensed tbl_page" style="border: 1">
				...
				<tr>
					...
					<th style="vertical-align: middle; text-align: center"
						width="50px"><spring:message code="ftz.label.COUNTRY_CODE" /></th>
				...
				<c:forEach var="dto1" items="${page.content}" varStatus="i">
					<tr>
						...
						<td class="vtip" style="text-align: left; width: 50px;"><t:codeValue
								...
								type="label" /></td>
						<td class="vtip" style="text-align: left; width: 50px;">${dto1.securitiesType}</td>
