<script type="text/javascript">
	...
	function addDetail() {
		...
		var input_Dtl_flag = $("#input_Dtl_flag").val();
		if ('add' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210202/AddDtlDtlSubmit";
		} else if ('upt' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210202/UptDtlDtlSubmit";
		}
		form.submit();
	}
	...
	function addRef() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210202/AddDtlDtlInit";
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210202.input.dtl.dtl" />
</div>
	...
	<form:form id="form"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td><form:select path="ftzInTxnDtl.securitiesType">
						<form:option value=""></form:option>
						<form:options items="${FTZ_SECURITIES_TYPE}" />
					</form:select></td>
				<td class="label_td"><spring:message
						code="ftz.label.SECURITIES_CODE" />：</td>
				<td><form:input id="orgTranDate" path="ftzInTxnDtl.securitiesCode"  maxlength="12"
...
<form:form id="form1" modelAttribute="FTZ210202Form" method="post">
