...
<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210203/AuthQry"
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210203Form.query_branchId}&query_submitDate_start=${FTZ210203Form.query_submitDate_start}&query_submitDate_end=${FTZ210203Form.query_submitDate_end}&query_msgId=${FTZ210203Form.query_msgId}&query_msgNo=${FTZ210203Form.query_msgNo}&query_accountNo=${FTZ210203Form.query_accountNo}"
								action="/FTZ210203/AuthQry" /></td>
					</tr>
				</table>
			</td>
		</tr>
