<script type="text/javascript">
	$(function() {
		...
		$("#pageTable").find("tr").bind(
				...
				function() {
					...
					var selected_seqNo = $(this).find("td:eq(9)").text();
					showDialog(
							'${pageContext.request.contextPath}/FTZ210203/QryAuthDtlDtl?selected_msgId='
	...
	function queryFTZ210203Dtl() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210203/QryAuthDtl?page.page="+ ${page.number + 1};
		form.submit();
	}
	...
	function sbDtl() {
		...
		$("#balance").val($("#balance").val().replaceAll(",", ""));
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210203/AuthDtlSubmit";
		form.submit();
	}
</script>
...
<div class="page_title"><spring:message code="ftzmis.title.210203.auth.dtl" /></div>
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td><t:moneyFormat type="text" id="balance" name="ftzInMsgCtl.balance"
						value="${FTZ210203Form.ftzInMsgCtl.balance}"
				...
				<c:forEach var="dto1" items="${page.content}" varStatus="i">
					<tr>
						...
						<td class="vtip" style="text-align: left; width: 50px;"><t:codeValue
								...
								type="label" /></td>
						<td class="vtip" style="text-align: left; width: 50px;">${dto1.oppAccount}</td>
...
<div class="pagination pull-right" style="margin-top: 10px;">
	<div class="rightPage">
		<util:pagination page="${page}"
			query="selected_msgId=${FTZ210203Form.ftzInMsgCtl.msgId}" />
	</div>
</div>
