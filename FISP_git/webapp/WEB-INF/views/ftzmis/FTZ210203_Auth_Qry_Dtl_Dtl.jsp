<script type="text/javascript">
	...
	function authPass() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210203/AuthDtlDtlSubmit?authStat=1";
		form.submit();
	}
	...
	function authRefuse() {
		$("#amount").val($("#amount").val().replaceAll(",", ""));
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210203/AuthDtlDtlSubmit?authStat=0";
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210203.auth.dtl.dtl" />
</div>
