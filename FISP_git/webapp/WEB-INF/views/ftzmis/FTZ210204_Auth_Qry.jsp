<script type="text/javascript">
	$(function() {
		...
		$("#pageTable").find("tr").bind(
				...
				function() {
					...
					var selected_msgNo = $(this).find("td:eq(9)").text();
					showDialog(
							'${pageContext.request.contextPath}/FTZ210204/QryAuthRedirect?selected_msgId='
	...
	function queryFTZ210204() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210204/AuthQry?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210204/AuthQry"
			...
			<thead>
				...
				<tr>
					...
					<th style="vertical-align: middle; text-align: center"
						width="110px"><spring:message code="ftz.label.MSG_TYPE" /></th>
					<th style="vertical-align: middle; text-align: center"
			...
			<tbody>
				<c:forEach var="dto" items="${page.content}" varStatus="i">
					<tr>
						...
						<td class="vtip" style="text-align: left; width: 110px;"><t:codeValue
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210204Form.query_branchId}&query_submitDate_start=${FTZ210204Form.query_submitDate_start}&query_submitDate_end=${FTZ210204Form.query_submitDate_end}&query_msgId=${FTZ210204Form.query_msgId}&query_msgNo=${FTZ210204Form.query_msgNo}&query_accountNo=${FTZ210204Form.query_accountNo}"
								action="/FTZ210204/AuthQry" /></td>
					</tr>
				</table>
			</td>
		</tr>
