<script type="text/javascript">
	...
	function addDetail() {
		...
		var input_Dtl_flag = $("#input_Dtl_flag").val();
		if ('add' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210204/AddDtlDtlSubmit";
		} else if ('upt' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210204/UptDtlDtlSubmit";
		}
		form.submit();
	}
	...
	function addRef() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210204/AddDtlDtlInit";
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210204.input.dtl.dtl" />
</div>
...
<form:form id="form1" modelAttribute="FTZ210204Form" method="post">
