<script type="text/javascript">
				...
				.bind(
						...
						function() {
							...
							var selected_msgNo = $(this).find("td:eq(8)")
									.text();
							showDialog('${pageContext.request.contextPath}/FTZ210204/QryRedirect?selected_msgId='
									+ selected_msgId
									+ "&selected_msgNo="
	...
	function queryFTZ210204() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210204/Qry";
		form.submit();
	}
</script>
...
<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210204/Qry"
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210204Form.query_branchId}&query_submitDate_start=${FTZ210204Form.query_submitDate_start}&query_submitDate_end=${FTZ210204Form.query_submitDate_end}&query_msgId=${FTZ210204Form.query_msgId}&query_accountName=${FTZ210204Form.query_accountName}&query_accountNo=${FTZ210204Form.query_accountNo}&query_msgStatus=${FTZ210204Form.query_msgStatus}&query_msgNo=${FTZ210204Form.query_msgNo}"
								action="/FTZ210204/Qry" /></td>
					</tr>
				</table>
			</td>
		</tr>
