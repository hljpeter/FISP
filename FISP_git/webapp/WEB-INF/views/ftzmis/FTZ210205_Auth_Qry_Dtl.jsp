<script type="text/javascript">
	$(function() {
		...
		$("#pageTable").find("tr").bind(
				...
				function() {
					...
					var selected_seqNo = $(this).find("td:eq(9)").text();
					showDialog(
							'${pageContext.request.contextPath}/FTZ210202/QryAuthDtlDtl?selected_msgId='
	...
	function showDetaildetail() {
		...
		if (null == selected_seqNo || "" == selected_seqNo) {
			...
			showDialog(
					'${pageContext.request.contextPath}/FTZ210205/QryAuthDtlDtl?selected_msgId='
							+ selected_msgId + "&selected_seqNo="
							+ selected_seqNo, '500', '1024');
			queryFTZ210205Dtl();
		}
	...
	function queryFTZ210205Dtl() {
		$("#selected_msgId").val($("#msgId").val());
		$("#balance").val($("#balance").val().replaceAll(",", ""));
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210205/QryAuthDtl?page.page="+ ${page.number + 1};
		form.submit();
	}
	...
	function sbDtl() {
		...
		$("#balance").val($("#balance").val().replaceAll(",", ""));
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210205/AuthDtlSubmit";
		form.submit();
	}
</script>
...
<div class="page_title"><spring:message code="ftzmis.title.210205.auth.dtl" /></div>
	...
	<form:form id="form"
		...
		<table class="tbl_search">
			<tr>
				...
				<td><form:input id="msgId" path="ftzInMsgCtl.msgId" disabled="true"
...
<div class="row" style="margin-bottom: 40px;">
	<div class="navbar navbar-fixed-bottom text-center" id="footer"
		...
		<input id="detaildetail" type="button" class="btn btn-primary"
			...
			value="<spring:message code="ftz.label.balanceValidation"/>"><input type="button" class="btn btn-primary"
