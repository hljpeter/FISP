<script type="text/javascript">
				...
				.bind(
						...
						function() {
							var selected_msgId = $(this).find("td:eq(3)")
									.text();
							var selected_msgType = $(this).find("td:eq(8)").text();
							showDialog('${pageContext.request.contextPath}/FTZ210205/QryDtl?selected_msgId='
	...
	function sbDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210205/SubmitDtl";
	...
	function delDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210205/InputDel";
	...
	function addDetail() {
		showDialog('${pageContext.request.contextPath}/FTZ210205/AddDtlInit','500','1024');
		queryFTZ210205();
	}
	function uptDetail() {
		var selected_msgId = $("#selected_msgId").val();
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			if ("01" == selected_msgType || "04" == selected_msgType|| "02" == selected_msgType) {
				showDialog('${pageContext.request.contextPath}/FTZ210205/UptDtlInit?selected_msgId='
						+ selected_msgId,'500','1024');
				queryFTZ210205();
			}else{
	...
	function queryFTZ210205() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210205/AddQry?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210205.input" />
</div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210205/AddQry"
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210205Form.query_branchId}&query_submitDate_start=${FTZ210205Form.query_submitDate_start}&query_submitDate_end=${FTZ210205Form.query_submitDate_end}&query_msgId=${FTZ210205Form.query_msgId}&query_accountName=${FTZ210205Form.query_accountName}&query_accountNo=${FTZ210205Form.query_accountNo}&query_msgStatus=${FTZ210205Form.query_msgStatus}"
								action="/FTZ210205/AddQry" /></td>
					</tr>
				</table>
			</td>
		</tr>
