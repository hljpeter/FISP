...
var txnStatus='${FTZ210206Form.ftzInTxnDtl.chkStatus }';
if(txnStatus=='03')
{
...
$("#next").click(function() {
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210206/Auth/DtlTxn/Next");
	$("#form").submit();
});
...
<div class="page_title"><spring:message code="ftzmis.title.210206.auth.dtl.dtl" /></div>
