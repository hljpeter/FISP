...
function queryFTZ210207() {
	...
	form.action = "${pageContext.request.contextPath}/FTZ210207/AddQry";
	form.submit();
}
</script>
<!-- tips information -->
...
<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
	<div class="leftPage">
		<util:pagination page="${page}" query="ftzInMsgCtlVO.branchId=${FTZ210207Form.ftzInMsgCtlVO.branchId }&ftzInMsgCtlVO.startDate=${FTZ210207Form.ftzInMsgCtlVO.startDate }&ftzInMsgCtlVO.endDate=${FTZ210207Form.ftzInMsgCtlVO.endDate }&ftzInMsgCtlVO.msgId=${FTZ210207Form.ftzInMsgCtlVO.msgId }&ftzInMsgCtlVO.msgStatus=${FTZ210207Form.ftzInMsgCtlVO.msgStatus }&ftzInMsgCtlVO.accountNo=${FTZ210206Form.ftzInMsgCtlVO.accountNo }" />
	</div>
</div>
<div class="row">
