...
//$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210207/AddQry");
...
$("#del").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210207/Input/DelMsg");
			$("#form").submit();
		} else {
			return false;
		}
...
$("#sbm").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#makDatetime").val(selectedRow.makDatetime);
			$("#msgStatus").val(selectedRow.msgStatus);
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210207/Input/SubmitMsg");
			$("#form").submit();
		} else {
			return false;
		}
...
$("#upt").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		var msg = $("#confirmMsg1").val() + $(this).html() + $("#confirmMsg2").val();
			//$("#makDatetime").val(selectedRow.makDatetime);
			showDialog('${pageContext.request.contextPath}/FTZ210207/Input/UptMsg/Init?ftzInMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
			queryFTZ210207();
			//window.location.href = '${pageContext.request.contextPath}/FTZ210207/Input/Qry?ftzInMsgCtlVO.branchId=${FTZ210207Form.ftzInMsgCtlVO.branchId }&ftzInMsgCtlVO.startDate=${FTZ210207Form.ftzInMsgCtlVO.startDate }&ftzInMsgCtlVO.endDate=${FTZ210207Form.ftzInMsgCtlVO.endDate }&ftzInMsgCtlVO.msgNo=${FTZ210207Form.ftzInMsgCtlVO.msgNo }&ftzInMsgCtlVO.msgStatus=${FTZ210207Form.ftzInMsgCtlVO.msgStatus }';
	}
});
...
//add
$("#add").click(function() {
	showDialog('${pageContext.request.contextPath}/FTZ210207/Input/AddMsg/Init', '500', '1040');
	queryFTZ210207();
	//window.location.href = '${pageContext.request.contextPath}/FTZ210207/Input/Qry?ftzInMsgCtlVO.startDate=' 
...
function queryFTZ210207() {
	var form = document.getElementById("form");
	form.action = "${pageContext.request.contextPath}/FTZ210207/AddQry?page.page="+${page.number+1};
	form.submit();
}
</script>
<!-- tips information -->
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210207.input"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/FTZ210207/AddQry" method="post" modelAttribute="FTZ210207Form" class="form-horizontal">
...
<div class="row">
    ...
    <div class="tbl_page_body">
		<table id="pageTable" class="table table-striped table-bordered table-condensed tbl_page">
			<tbody>
			<form:form id="FTZ210207Form" action="${pageContext.request.contextPath}" modelAttribute="FTZ210207Form">
	...
	<table class="text-center">
		...
		<button id="dtl" name="btn" class="btn btn-primary"><spring:message code="ftz.label.MSG_Dtl"/></button>
			...
			<td width="50%" align="right">
				<table>
					<tr>
						<td><util:pagination page="${page}" query="ftzInMsgCtlVO.branchId=${FTZ210207Form.ftzInMsgCtlVO.branchId }&ftzInMsgCtlVO.startDate=${FTZ210207Form.ftzInMsgCtlVO.startDate }&ftzInMsgCtlVO.endDate=${FTZ210207Form.ftzInMsgCtlVO.endDate }&ftzInMsgCtlVO.msgId=${FTZ210207Form.ftzInMsgCtlVO.msgId }&ftzInMsgCtlVO.msgStatus=${FTZ210207Form.ftzInMsgCtlVO.msgStatus }&ftzInMsgCtlVO.accountNo=${FTZ210207Form.ftzInMsgCtlVO.accountNo }" /></td>
					</tr>
				</table>
			</td>
		</tr>
