<!-- 6.3.3　应付保函/备用证（210207） / 录入新增 - 交易页面 -->
<script type="text/javascript">
$(function() {
var actionFlag = '${FTZ210207Form.actionFlag }';
if (actionFlag == "addTxn") {
	$(".dtl").css("display", "none");
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210207/Input/AddTxn/Submit");
	...
	$(".dtl").css("display", "none");
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210207/Input/UptTxn/Submit");
	var success = '${successmsg }';
	if (success && success != "") {
		$("button[type=button]").attr("disabled", true);
		$("input").attr("readonly", true);
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210207.input.dtl.dtl"/></div>
<!-- body -->
<div class="row">
...
<table class="tbl_search">
			...
			<tr>
				...
				<td colspan="3"><t:moneyFormat type="text" id="amount"
						...
						value="${FTZ210207Form.ftzInTxnDtl.amount}"
