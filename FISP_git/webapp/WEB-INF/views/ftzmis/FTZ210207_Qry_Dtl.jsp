<script type="text/javascript">
		...
		$("#pageTable")
				...
				.bind(
						...
						function() {
							...
							window
									.showModalDialog(
											'${pageContext.request.contextPath}/FTZ210207/QryDtlDtl?ftzInTxnDtl.msgId='
													+ selected_msgId
													+ "&ftzInTxnDtl.seqNo="
													+ selected_seqNo,
											window,
	...
	function queryFTZ210207Dtl() {
		$("#selected_msgId").val($("#msgId").val());
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210207/QryDtl";
		form.submit();
	}
</script>
...
<div class="page_title"><spring:message code="ftzmis.title.210207.qry.dtl" /></div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/BMG_TASK_Qry/Qry"
		method="post" modelAttribute="FTZ210207Form" class="form-horizontal">
...
<div class="pagination pull-right" style="margin-top: 10px;">
	<div class="rightPage">
		<util:pagination page="${page}"
			query="selected_msgId=${FTZ210207Form.ftzInMsgCtl.msgId}" />
	</div>
</div>
