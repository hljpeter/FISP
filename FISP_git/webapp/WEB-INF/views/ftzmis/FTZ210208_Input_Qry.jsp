...
$("#dtl").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		selectedRow = eval("(" + checkSelected() + ")"); 
		showDialog('${pageContext.request.contextPath}/FTZ210208/Input/Dtl/Init?ftzInMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
	}
});
...
.bind(
		...
		function() {
			...
			showDialog('${pageContext.request.contextPath}/FTZ210208/Input/Dtl/Init?ftzInMsgCtl.msgId=' + selected_msgId, '500', '1040');
...
function queryFTZ210208() {
	...
	form.action = "${pageContext.request.contextPath}/FTZ210208/AddQry";
	form.submit();
}
</script>
<!-- tips information -->
...
<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
	<div class="leftPage">
		<util:pagination page="${page}" query="ftzInMsgCtlVO.branchId=${FTZ210208Form.ftzInMsgCtlVO.branchId }&ftzInMsgCtlVO.startDate=${FTZ210208Form.ftzInMsgCtlVO.startDate }&ftzInMsgCtlVO.endDate=${FTZ210208Form.ftzInMsgCtlVO.endDate }&ftzInMsgCtlVO.msgId=${FTZ210208Form.ftzInMsgCtlVO.msgId }&ftzInMsgCtlVO.msgStatus=${FTZ210208Form.ftzInMsgCtlVO.msgStatus }&ftzInMsgCtlVO.accountNo=${FTZ210206Form.ftzInMsgCtlVO.accountNo }" />
	</div>
</div>
<div class="row">
