<script type="text/javascript">
		...
		$("#pageTable")
				...
				.bind(
						...
						function() {
							...
							window
									.showModalDialog(
											'${pageContext.request.contextPath}/FTZ210208/QryDtlDtl?ftzInTxnDtl.msgId='
													+ selected_msgId
													+ "&ftzInTxnDtl.seqNo="
													+ selected_seqNo,
											window,
	...
	function queryFTZ210208Dtl() {
		$("#selected_msgId").val($("#msgId").val());
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210208/QryDtl";
		form.submit();
	}
</script>
...
<div class="page_title"><spring:message code="ftzmis.title.210208.qry.dtl" /></div>
...
<div class="pagination pull-right" style="margin-top: 10px;">
	<div class="rightPage">
		<util:pagination page="${page}"
			query="selected_msgId=${FTZ210208Form.ftzInMsgCtl.msgId}" />
	</div>
</div>
