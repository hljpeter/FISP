...
$("#dtl").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		showDialog('${pageContext.request.contextPath}/FTZ210209/Auth/DtlTxn/Init?ftzInTxnDtl.msgId=' 
				+ $("#msgId").val() + "&ftzInTxnDtl.seqNo=" + selectedRow.seqNo, '600', '1040');
		
		$("#balance").val($("#balance").val().replaceAll(",", ""));
		$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210209/Auth/DtlMsg/Init?page.page=${page.number+1}");
		$("#form").submit();
...
<div class="page_title"><spring:message code="ftzmis.title.210209.auth.dtl" /></div>

<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/FTZ210209/Auth/DtlMsg/Auth" method="post" modelAttribute="FTZ210209Form" class="form-horizontal">
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" query="ftzInMsgCtl.msgId=${FTZ210209Form.ftzInMsgCtl.msgId }&operFlag=${FTZ210209Form.operFlag }" />
		</div>
	</div>
</div>
