...
$("#dtl").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		selectedRow = eval("(" + checkSelected() + ")"); 
		showDialog('${pageContext.request.contextPath}/FTZ210209/QryDtl?ftzInMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
	}
});
...
.bind(
		...
		function() {
			...
			showDialog('${pageContext.request.contextPath}/FTZ210209/QryDtl?ftzInMsgCtl.msgId=' + selected_msgId, '500', '1040');
