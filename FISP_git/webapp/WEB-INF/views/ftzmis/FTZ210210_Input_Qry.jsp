<script type="text/javascript">
				...
				.bind(
						...
						function() {
							var selected_msgId = $(this).find("td:eq(3)")
									.text();
							showDialog('${pageContext.request.contextPath}/FTZ210210/QryDtl?selected_msgId='
	...
	function sbDetail() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210210/SubmitDtl";
	...
	function delDetail() {
		...
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210210/InputDel";
	...
	function addDetail() {
		showDialog('${pageContext.request.contextPath}/FTZ210210/AddDtlInit?time=' + new Date().getTime(),'500','1024');
		queryFTZ210210();
	}
	function uptDetail() {
		var selected_msgId = $("#selected_msgId").val();
		...
		if ("01" == selected_msgType || "04" == selected_msgType
				|| "02" == selected_msgType) {
			showDialog('${pageContext.request.contextPath}/FTZ210210/UptDtlInit?selected_msgId='
					+ selected_msgId + '&time=' + new Date().getTime(),'500','1024');
			queryFTZ210210();
		} else {
	...
	function queryFTZ210210() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210210/AddQry?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210210/AddQry"
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210210Form.query_branchId}&query_submitDate_start=${FTZ210210Form.query_submitDate_start}&query_submitDate_end=${FTZ210210Form.query_submitDate_end}&query_msgId=${FTZ210210Form.query_msgId}&query_accountNo=${FTZ210210Form.query_accountNo}&query_msgStatus=${FTZ210210Form.query_msgStatus}"
								action="/FTZ210210/AddQry" /></td>
					</tr>
				</table>
			</td>
		</tr>
