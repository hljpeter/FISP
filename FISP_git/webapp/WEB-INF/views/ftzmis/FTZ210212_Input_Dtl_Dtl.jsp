<script type="text/javascript">
	...
	function addDetail() {
		...
		var input_Dtl_flag = $("#input_Dtl_flag").val();
		if ('add' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210212/AddDtlDtlSubmit";
		} else if ('upt' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210212/UptDtlDtlSubmit";
		}
		form.submit();
	}
	...
	function addRef() {
		...
		form1.action = "${pageContext.request.contextPath}/FTZ210212/AddDtlDtlInit";
		form1.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210212.input.dtl.dtl" />
</div>
...
<form:form id="form1" modelAttribute="FTZ210212Form" method="post">
