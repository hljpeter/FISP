		...
		$("#pageTable")
				...
				.bind(
						...
						function() {
							...
							window
									.showModalDialog(
											'${pageContext.request.contextPath}/FTZ2102/QryAuthRedirect?selected_msgId='
													+ selected_msgId
													+ "&selected_msgNo="
													+ selected_msgNo,
											window,
...
<div id="id_showMsg" style="display: none">
	...
	<div id="id_result">
		<t:messagePanel />
		<spring:hasBindErrors name="fTZ2102Form">
			<form:form commandName="fTZ2102Form">
...
<div class="row">
	<form:form id="form"
		...
		method="post" modelAttribute="FTZ2102Form" class="form-horizontal">
		...
		<table class="tbl_search">
			...
			<td class="label_td">
				...
				<td>
					<form:select path="query_currency" id="query_currency"
						>
						<form:option value=""></form:option>
				...
				<spring:message code="ftz.label.BALANCE_CODE" />：<form:select
						id="query_balanceCode" path="query_balanceCode" >
						<form:option value=""></form:option>
			...
			<tr>
			<td class="label_td"><spring:message code="ftz.label.OWNER_ACC_ORG_CODE" />：</td>
				<td>
					<form:select id="query_accOrgCode" path="query_accOrgCode" >
						<form:option value=""></form:option>
						<form:options items="${SM_0002}" />
					</form:select></td>
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${fTZ2102Form.query_branchId}&query_submitDate_start=${fTZ2102Form.query_submitDate_start}&query_submitDate_end=${fTZ2102Form.query_submitDate_end}&query_msgId=${fTZ2102Form.query_msgId}&query_accountName=${fTZ2102Form.query_accountName}&query_accountNo=${fTZ2102Form.query_accountNo}"
								action="/FTZ2102/AuthQry" /></td>
					</tr>
				</table>
			</td>
		</tr>
