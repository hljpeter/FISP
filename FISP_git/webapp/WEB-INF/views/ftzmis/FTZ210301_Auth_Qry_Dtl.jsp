...
$(".tbl_page_body table tr").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210301/Auth/DtlTxn/Init?ftzOffTxnDtl.msgId=' 
...
$("#dtl").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210301/Auth/DtlMsg/Init?page.page=" + ${page.number + 1 } + "&FtzOffMsgCtl.msgId="+ ${FTZ210301Form.ftzOffMsgCtl.msgId });
		$("#form").submit();
	}
});
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210301.auth.msg"/></div>
<!-- body -->
<div class="row">
		...
		<table class="table table-striped table-bordered table-condensed tbl_page">
			...
			<tr>
	        	<th class="tbl_page_th" width="20px"><spring:message code="ftz.label.NO"/></th>
	          	...
	          	<th class="tbl_page_th" width="80px"><spring:message code="ftz.label.ENT_ACCOUNT_NO"/></th>
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" action="/FTZ210301/Auth/DtlMsg/Init" query="operFlag=${FTZ210303Form.operFlag }&ftzOffMsgCtl.msgId=${FTZ210301Form.ftzOffMsgCtl.msgId }" />
		</div>
	</div>
</div>
<div class="row">
