...
$("#del").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210301/Input/DelMsg?page.page=" + ${page.number + 1 });
			$("#form").submit();
		} else {
			return false;
		}
...
// add
$("#add").click(function() {
	showDialogAndRefresh('${pageContext.request.contextPath}/FTZ210301/Input/AddMsg/Init?page.page=' + ${page.number + 1 }, '500', '1040');
