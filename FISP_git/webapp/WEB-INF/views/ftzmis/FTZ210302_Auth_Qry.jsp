<script type="text/javascript">
	...
	function showDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			window
					.showModalDialog(
							'${pageContext.request.contextPath}/FTZ210302/QryAuthDtl?selected_msgId='
	...
	function queryFTZ210302() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210302/AuthQry";
		form.submit();
	}
</script>
...
<div class="page_title"><spring:message code="ftzmis.title.210302.auth" /><!-- 应付信用证录入/修改 --></div>
	...
	<form:form id="form"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td align="right"><button type="button" class="btn btn-primary" id="qry" onclick="queryFTZ210302()">
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210302Form.query_branchId}&query_submitDate_start=${FTZ210302Form.query_workDate_start}&query_submitDate_end=${FTZ210302Form.query_workDate_end}&query_msgId=${FTZ210302Form.query_msgId}&query_msgStatus=${FTZ210302Form.query_msgStatus}" action="/FTZ210302/AuthQry"/></td>
					</tr>
				</table>
			</td>
		</tr>
