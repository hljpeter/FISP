...
$(".tbl_page_body table tr ").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210302/Input/DtlTxn/Init?ftzOffTxnDtl.msgId=' 
...
if (actionFlag == "addMsg") {
	...
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210302/Input/AddMsg/Sumbit");
	...
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210302/Input/UptMsg/Sumbit");
	$(".pboc").css("display", "");
	//var success = '${successmsg}';
	//if (success && success != '') {
	//	$("input[type=submit]").attr("disabled", true);
	...
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210302/Input/UptMsg/Sumbit");
	//var operFlag = '${FTZ210302Form.operFlag }';
	//if (operFlag == "updated") {
	//	$("input[type=submit]").attr("disabled", true);
	//}
}
...
// add
$("#add").click(function() {
	showDialog('${pageContext.request.contextPath}/FTZ210302/Input/AddTxn/Init?ftzOffTxnDtl.msgId=' 
		+ $("#msgId").val() + '&time=' + new Date().getTime(), '600', '1040');
	
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210302/Input/UptMsg/Init");
	$("#form").submit();
});
...
$("#upt").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (selectedRow.chkStatus == '03') {
			...
			showDialog('${pageContext.request.contextPath}/FTZ210302/Input/UptTxn/Init?ftzOffTxnDtl.msgId=' 
					+ $("#msgId").val() + '&ftzOffTxnDtl.seqNo=' + selectedRow.seqNo + '&time=' + new Date().getTime(), '600', '1040');
			
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210302/Input/UptMsg/Init?page.page=" + ${page.number + 1 });
			$("#form").submit();
		}
	}
});
...
$("#del").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (selectedRow.chkStatus == '03') {
			...
			if (confirm(msg)) {
				$("#operFlag").val("updated");
				$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210302/Input/DelTxn/Submit?page.page=" + ${page.number + 1 } + "&ftzOffTxnDtl.msgId=" 
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210302.input.msg"/></div>
<!-- body -->
<div class="row">
		...
		<table class="table table-striped table-bordered table-condensed tbl_page">
			...
			<tr>
	        	<th class="tbl_page_th" width="20px"><spring:message code="ftz.label.NO"/></th>
	          	...
	          	<th class="tbl_page_th" width="100px"><spring:message code="ftz.label.APPLICANT_ENT_NAME"/></th>
	          	...
	          	<th class="tbl_page_th" width="160px"><spring:message code="ftz.label.APPLICANT_DISTRICT_CODE"/></th>
		...
		<table class="table table-striped table-bordered table-condensed tbl_page">
			...
			<c:forEach var="dto" items="${page.content}" varStatus="i">
				<tr id='{seqNo:"${dto.seqNo }",makDatetime:"${dto.makDatetime }",chkDatetime:"${dto.chkDatetime }",chkStatus:"${dto.chkStatus }"}'>
				  	...
				  	<td class="tbl_page_td_left vtip" width="100px"><t:codeValue items="${SM_0002 }" key="${dto.accountName }" type="label" /></td>
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" action="/FTZ210302/Input/UptMsg/Init" query="ftzOffMsgCtl.msgId=${FTZ210302Form.ftzOffMsgCtl.msgId }" />
		</div>
	</div>
</div>
