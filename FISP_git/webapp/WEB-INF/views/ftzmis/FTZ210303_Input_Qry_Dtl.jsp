...
$(".tbl_page_body table tr ").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210303/Input/DtlTxn/Init?ftzOffTxnDtl.msgId=' 
...
if (actionFlag == "addMsg") {
	...
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210303/Input/AddMsg/Sumbit");
	...
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210303/Input/UptMsg/Sumbit");
	//var operFlag = '${FTZ210303Form.operFlag }';
	//if (operFlag == "updated") {
	//	$("input[type=submit]").attr("disabled", true);
	//}
}
...
// add
$("#add").click(function() {
	showDialog('${pageContext.request.contextPath}/FTZ210303/Input/AddTxn/Init?ftzOffTxnDtl.msgId=' 
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210303.input.msg"/></div>
<!-- body -->
<div class="row">
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" action="/FTZ210303/Input/UptMsg/Init" query="ftzOffMsgCtl.msgId=${FTZ210303Form.ftzOffMsgCtl.msgId }" />
		</div>
	</div>
</div>
