<!-- 6.3.4　信用证保兑（210304） - 进口应付 / 查询 - 报文页面 -->
...
$(".tbl_page_body table tr").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210304/Qry/DtlTxn/Init?ftzOffTxnDtl.msgId=' 
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210304.qry.msg"/></div>
<!-- body -->
<div class="row">
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" action="/FTZ210304/Auth/DtlMsg/Init" query="ftzOffMsgCtl.msgId=${FTZ210304Form.ftzOffMsgCtl.msgId }" />
		</div>
	</div>
</div>
<div class="row">
