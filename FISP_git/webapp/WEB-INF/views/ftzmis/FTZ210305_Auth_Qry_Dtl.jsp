...
$(".tbl_page_body table tr").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210305/Auth/DtlTxn/Init?ftzOffTxnDtl.msgId=' 
...
$("#dtl").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (selectedRow.chkStatus == '04') {
			...
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210305/Auth/DtlMsg/Init?page.page=" + ${page.number + 1 } + "&FtzOffMsgCtl.msgId="+ ${FTZ210305Form.ftzOffMsgCtl.msgId });
			$("#form").submit();
		}
	}
});
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210305.auth.msg"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/FTZ210305/Auth/DtlMsg/Auth" method="post" modelAttribute="FTZ210305Form" class="form-horizontal">
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" action="/FTZ210305/Auth/DtlMsg/Init" query="operFlag=${FTZ210303Form.operFlag }&ftzOffMsgCtl.msgId=${FTZ210305Form.ftzOffMsgCtl.msgId }" />
		</div>
	</div>
</div>
