...
$(".tbl_page_body table tr ").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210305/Input/Dtl/Init?ftzOffMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
});

//$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210305/Input/Qry");
...
$("#del").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210305/Input/DelMsg?page.page=" + ${page.number + 1 });
			$("#form").submit();
		} else {
			return false;
		}
...
$("#sbm").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#makDatetime").val(selectedRow.makDatetime);
			$("#msgStatus").val(selectedRow.msgStatus);
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210305/Input/SubmitMsg?page.page=" + ${page.number + 1 });
			$("#form").submit();
		} else {
			return false;
		}
...
$("#upt").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		selectedRow = eval("(" + selectedRow + ")");
		$("#makDatetime").val(selectedRow.makDatetime);
		showDialog('${pageContext.request.contextPath}/FTZ210305/Input/UptMsg/Init?ftzOffMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
		window.location.href = '${pageContext.request.contextPath}/FTZ210305/Input/Qry?ftzOffMsgCtlVO.branchId=${FTZ210305Form.ftzOffMsgCtlVO.branchId }&ftzOffMsgCtlVO.startDate=${FTZ210305Form.ftzOffMsgCtlVO.startDate }&ftzOffMsgCtlVO.endDate=${FTZ210305Form.ftzOffMsgCtlVO.endDate }&ftzOffMsgCtlVO.msgNo=${FTZ210305Form.ftzOffMsgCtlVO.msgNo }&ftzOffMsgCtlVO.msgStatus=${FTZ210305Form.ftzOffMsgCtlVO.msgStatus }';
	}
});
...
// add
$("#add").click(function() {
	showDialogAndRefresh('${pageContext.request.contextPath}/FTZ210305/Input/AddMsg/Init', '500', '1040');
	//window.location.href = '${pageContext.request.contextPath}/FTZ210305/Input/Qry?ftzOffMsgCtlVO.startDate=' 
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210305.input"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/FTZ210305/Input/Qry" method="post" modelAttribute="FTZ210305Form" class="form-horizontal">
...
<div class="row">
    ...
    <div class="tbl_page_body">
		<table class="table table-striped table-bordered table-condensed tbl_page">
			<tbody>
			<form:form id="FTZ210305Form" action="${pageContext.request.contextPath}" modelAttribute="FTZ210305Form">
	...
	<table class="text-center">
		<tr>
			...
			<td width="50%" align="right">
				<table><tr><td>
					<util:pagination page="${page }" action="/FTZ210305/Input/Qry" query="ftzOffMsgCtlVO.branchId=${FTZ210305Form.ftzOffMsgCtlVO.branchId }&ftzOffMsgCtlVO.startDate=${FTZ210305Form.ftzOffMsgCtlVO.startDate }&ftzOffMsgCtlVO.endDate=${FTZ210305Form.ftzOffMsgCtlVO.endDate }&ftzOffMsgCtlVO.msgId=${FTZ210305Form.ftzOffMsgCtlVO.msgId }&ftzOffMsgCtlVO.msgStatus=${FTZ210305Form.ftzOffMsgCtlVO.msgStatus }" />	
				</td></tr></table>
			</td>
		</tr>
	</table>
