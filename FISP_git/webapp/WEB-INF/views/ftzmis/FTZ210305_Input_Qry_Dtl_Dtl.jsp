<!-- 6.3.5　应付银行承兑汇票（210305） / 录入新增&修改 - 交易页面 -->
<script type="text/javascript">
$(function() {
var actionFlag = '${FTZ210305Form.actionFlag }';
if (actionFlag == "addTxn") {
	$(".dtl").css("display", "none");
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210305/Input/AddTxn/Submit");
	...
	if (success && success != "") {
		...
		$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210305/Input/AddTxn/Init");
	...
	$(".dtl").css("display", "none");
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210305/Input/UptTxn/Submit");
	...
	if (success && success != "") {
		...
		$(".date").attr("disabled", true);
		$("#sbm").attr("disabled", true);
		$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210305/Input/UptTxn/Init");
	}
} 
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210305.input.txn"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}" method="post" modelAttribute="FTZ210305Form" class="form-horizontal">
		...
		<table class="tbl_search">
			...
			<tr>	
				...
				<td><t:moneyFormat type="text" id="amount" name="ftzOffTxnDtl.amount" value="${FTZ210305Form.ftzOffTxnDtl.amount }" format="###,###,###,###.00" dot="true" /></td>
			...
			<tr>	
				...
				<td><form:input id="accountNo" path="ftzOffTxnDtl.accountNo" class="input-large" maxLength="35"/></td>
