...
$(".tbl_page_body table tr ").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210307/Input/Dtl/Init?ftzOffMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
});

//$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210307/Input/Qry");
...
$("#del").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210307/Input/DelMsg?page.page=" + ${page.number + 1 });
			$("#form").submit();
		} else {
			return false;
		}
...
$("#sbm").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#msgStatus").val(selectedRow.msgStatus);
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210307/Input/SubmitMsg?page.page=" + ${page.number + 1 });
			$("#form").submit();
		} else {
			return false;
		}
...
$("#upt").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		selectedRow = eval("(" + selectedRow + ")");
		$("#makDatetime").val(selectedRow.makDatetime);
		showDialog('${pageContext.request.contextPath}/FTZ210307/Input/UptMsg/Init?ftzOffMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
		window.location.href = '${pageContext.request.contextPath}/FTZ210307/Input/Qry?ftzOffMsgCtlVO.branchId=${FTZ210307Form.ftzOffMsgCtlVO.branchId }&ftzOffMsgCtlVO.startDate=${FTZ210307Form.ftzOffMsgCtlVO.startDate }&ftzOffMsgCtlVO.endDate=${FTZ210307Form.ftzOffMsgCtlVO.endDate }&ftzOffMsgCtlVO.msgNo=${FTZ210307Form.ftzOffMsgCtlVO.msgNo }&ftzOffMsgCtlVO.msgStatus=${FTZ210307Form.ftzOffMsgCtlVO.msgStatus }';
	}
});
...
// add
$("#add").click(function() {
	showDialogAndRefresh('${pageContext.request.contextPath}/FTZ210307/Input/AddMsg/Init', '500', '1040');
	//window.location.href = '${pageContext.request.contextPath}/FTZ210307/Input/Qry?ftzOffMsgCtlVO.startDate=' 
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210307.input"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/FTZ210307/Input/Qry" method="post" modelAttribute="FTZ210307Form" class="form-horizontal">
	...
	<table class="text-center">
		<tr>
			...
			<td width="50%" align="right">
				<table><tr><td>
					<util:pagination page="${page }" action="/FTZ210307/Input/Qry" query="ftzOffMsgCtlVO.branchId=${FTZ210307Form.ftzOffMsgCtlVO.branchId }&ftzOffMsgCtlVO.startDate=${FTZ210307Form.ftzOffMsgCtlVO.startDate }&ftzOffMsgCtlVO.endDate=${FTZ210307Form.ftzOffMsgCtlVO.endDate }&ftzOffMsgCtlVO.msgId=${FTZ210307Form.ftzOffMsgCtlVO.msgId }&ftzOffMsgCtlVO.msgStatus=${FTZ210307Form.ftzOffMsgCtlVO.msgStatus }" />	
				</td></tr></table>
			</td>
		</tr>
	</table>
