...
$(".tbl_page_body table tr").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210307/Qry/DtlTxn/Init?ftzOffTxnDtl.msgId=' 
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210307.qry.msg"/></div>
<!-- body -->
<div class="row">
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" action="/FTZ210307/Auth/DtlMsg/Init" query="ftzOffMsgCtl.msgId=${FTZ210307Form.ftzOffMsgCtl.msgId }" />
		</div>
	</div>
</div>
<div class="row">
