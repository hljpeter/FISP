<!-- 6.3.8　信用证保兑（出口应收）（210308） / 审核 - 交易页面 -->
...
$("#next").click(function() {
	$("#amount").val($("#amount").val().replaceAll(",", ""));
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210308/Auth/DtlTxn/Next");
	$("#form").submit();
});
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210308.auth.txn"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}" method="post" modelAttribute="FTZ210308Form" class="form-horizontal">
		...
		<table class="tbl_search">
			<tr>
				...
				<td><t:dateTimeFormat type="text" value="${FTZ210308Form.ftzOffTxnDtl.submitDate }" format="date" name="ftzOffTxnDtl.submitDate" cssClass="input-large" readonly="true"/></td>
			</tr>
			<tr>	
				<!-- 所属机构代码 -->
			...
			<tr>	
				...
				<td colspan="3"><t:dateTimeFormat type="text" value="${FTZ210308Form.ftzOffTxnDtl.expirationDate }" format="date" name="ftzOffTxnDtl.expirationDate" cssClass="input-large" readonly="true"/></td>
			</tr>
