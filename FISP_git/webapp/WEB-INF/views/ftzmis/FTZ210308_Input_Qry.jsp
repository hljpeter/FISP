<!-- 6.3.8　信用证保兑（出口应收）（210308） / 录入查询页面 -->
...
$(".tbl_page_body table tr ").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210308/Input/Dtl/Init?ftzOffMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
});

//$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210308/Input/Qry");
...
$("#del").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210308/Input/DelMsg");
			$("#form").submit();
		} else {
			return false;
		}
...
$("#sbm").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#makDatetime").val(selectedRow.makDatetime);
			$("#msgStatus").val(selectedRow.msgStatus);
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210308/Input/SubmitMsg");
			$("#form").submit();
		} else {
			return false;
		}
...
$("#upt").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		selectedRow = eval("(" + selectedRow + ")");
		$("#makDatetime").val(selectedRow.makDatetime);
		showDialog('${pageContext.request.contextPath}/FTZ210308/Input/UptMsg/Init?ftzOffMsgCtl.msgId=' + selectedRow.msgId, '500', '1040');
		window.location.href = '${pageContext.request.contextPath}/FTZ210308/Input/Qry?ftzOffMsgCtlVO.branchId=${FTZ210308Form.ftzOffMsgCtlVO.branchId }&ftzOffMsgCtlVO.startDate=${FTZ210308Form.ftzOffMsgCtlVO.startDate }&ftzOffMsgCtlVO.endDate=${FTZ210308Form.ftzOffMsgCtlVO.endDate }&ftzOffMsgCtlVO.msgNo=${FTZ210308Form.ftzOffMsgCtlVO.msgNo }&ftzOffMsgCtlVO.msgStatus=${FTZ210308Form.ftzOffMsgCtlVO.msgStatus }';
	}
});
...
// add
$("#add").click(function() {
	showDialogAndRefresh('${pageContext.request.contextPath}/FTZ210308/Input/AddMsg/Init', '500', '1040');
	//window.location.href = '${pageContext.request.contextPath}/FTZ210308/Input/Qry?ftzOffMsgCtlVO.startDate=' 
...
<div id="id_showMsg" style="display: none"> 
	...
	<div id="id_result">
		...
		<spring:hasBindErrors name="FTZ210308Form">
			<form:form commandName="FTZ210308Form">
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210308.input"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/FTZ210308/Input/Qry" method="post" modelAttribute="FTZ210308Form" class="form-horizontal">
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" action="/FTZ210308/Input/Qry" query="ftzOffMsgCtlVO.branchId=${FTZ210308Form.ftzOffMsgCtlVO.branchId }&ftzOffMsgCtlVO.startDate=${FTZ210308Form.ftzOffMsgCtlVO.startDate }&ftzOffMsgCtlVO.endDate=${FTZ210308Form.ftzOffMsgCtlVO.endDate }&ftzOffMsgCtlVO.msgId=${FTZ210308Form.ftzOffMsgCtlVO.msgId }&ftzOffMsgCtlVO.msgStatus=${FTZ210308Form.ftzOffMsgCtlVO.msgStatus }" />
		</div>
	</div>
</div>
<div class="row">
