<!-- 6.3.8　信用证保兑（出口应收）（210308） / 查询 - 报文页面 -->
...
$(".tbl_page_body table tr").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210308/Qry/DtlTxn/Init?ftzOffTxnDtl.msgId=' 
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210308.qry.msg"/></div>
<!-- body -->
<div class="row">
