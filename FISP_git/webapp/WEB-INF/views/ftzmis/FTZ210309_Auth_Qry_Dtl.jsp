...
$(".tbl_page_body table tr").dblclick(function() {
	...
	showDialog('${pageContext.request.contextPath}/FTZ210309/Auth/DtlTxn/Init?ftzOffTxnDtl.msgId=' 
...
$("#dtl").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210309/Auth/DtlMsg/Init?page.page=" + ${page.number + 1 } + "&FtzOffMsgCtl.msgId="+ ${FTZ210309Form.ftzOffMsgCtl.msgId });
		$("#form").submit();
	}
});
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210309.auth.msg"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/FTZ210309/Auth/DtlMsg/Auth" method="post" modelAttribute="FTZ210309Form" class="form-horizontal">
...
<div class="row" style="margin-top: 10px;">
	<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
		<div class="leftPage">
			<util:pagination page="${page }" action="/FTZ210309/Auth/DtlMsg/Init" query="operFlag=${FTZ210303Form.operFlag }&ftzOffMsgCtl.msgId=${FTZ210309Form.ftzOffMsgCtl.msgId }" />
		</div>
	</div>
</div>
