...
$("button[name=btnChk]").click(function() {
	...
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210309/Auth/DtlTxn/Auth");
	$("#form").submit();
});

$("#next").click(function() {
	$("#amount").val($("#amount").val().replaceAll(",", ""));
	$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210309/Auth/DtlTxn/Next");
	$("#form").submit();
});
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210309.auth.txn"/></div>
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}" method="post" modelAttribute="FTZ210309Form" class="form-horizontal">
		...
		<table class="tbl_search">
			<tr>
				...
				<td><t:dateTimeFormat type="text" value="${FTZ210309Form.ftzOffTxnDtl.submitDate }" format="date" name="ftzOffTxnDtl.submitDate" cssClass="input-large" readonly="true"/></td>
			</tr>
			<tr>	
				<!-- 所属机构代码 -->
			...
			<tr>	
				...
				<td><t:moneyFormat type="text" id="amount" name="ftzOffTxnDtl.amount" value="${FTZ210309Form.ftzOffTxnDtl.amount }" format="###,###,###,###.00" dot="true" readonly="true"/></td>
			...
			<tr>	
				...
				<td>
					<form:input id="institutionCode" path="ftzOffTxnDtl.institutionCode" class="input-large" maxLength="11" readonly="true"/>
			...
			<tr>	
				...
				<td><t:dateTimeFormat type="text" value="${FTZ210309Form.ftzOffTxnDtl.tranDate }" format="date" name="ftzOffTxnDtl.tranDate" cssClass="input-large" readonly="true"/></td>
