...
$("#del").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210309/Input/DelMsg?page.page=" + ${page.number + 1 });
			$("#form").submit();
		} else {
			return false;
		}
...
$("#sbm").click(function() {
	...
	if (!selectedRow || selectedRow == "") {
		...
		if (confirm(msg)) {
			...
			$("#makDatetime").val(selectedRow.makDatetime);
			$("#msgStatus").val(selectedRow.msgStatus);
			$("#form").attr("action", "${pageContext.request.contextPath}/FTZ210309/Input/SubmitMsg?page.page=" + ${page.number + 1 });
			$("#form").submit();
