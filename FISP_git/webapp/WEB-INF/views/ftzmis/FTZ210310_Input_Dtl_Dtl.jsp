...
function addRef() {
	...
	form.action = "${pageContext.request.contextPath}/FTZ210310/AddDtlDtlInit";
	form.submit();
}
...
function addDetail() {
	...
	var actionFlag = "${FTZ210310Form.actionFlag}";
	if ('addTxn' == actionFlag) {
		form.action = "${pageContext.request.contextPath}/FTZ210310/AddDtlDtlSubmit";
	} else if ('updTxn' == actionFlag) {
		form.action = "${pageContext.request.contextPath}/FTZ210310/UpdDtlDtlSubmit";
	}
	form.submit();
}
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210310.input.txn"/></div>
<!-- body -->
<div class="row">
			...
			<tr>	
				...
				<td>
					<t:moneyFormat type="text" id="buyAmt" name="ftzOffTxnDtl.buyAmt"
						value="${FTZ210310Form.ftzOffTxnDtl.buyAmt}" format="###,###,###,###.00" dot="true" maxlength="24"/>
				</td>
				...
				<td>
					<t:moneyFormat type="text" id="sellAmt" name="ftzOffTxnDtl.sellAmt"
						value="${FTZ210310Form.ftzOffTxnDtl.sellAmt}" format="###,###,###,###.00" dot="true" maxlength="24"/>
				</td>
			</tr>
			<tr>	
				...
				<td>
					<t:moneyFormat type="text" id="buyRate" name="ftzOffTxnDtl.buyRate"
						value="${FTZ210310Form.ftzOffTxnDtl.buyRate}" format="###.000000" dot="true" maxlength="13"/>
				</td>
				...
				<td>
					<t:moneyFormat type="text" id="sellRate" name="ftzOffTxnDtl.sellRate"
						value="${FTZ210310Form.ftzOffTxnDtl.sellRate}" format="###.000000" dot="true" maxlength="13"/>
				</td>
			</tr>
			<tr>	
				<td class="label_td"><span style="color:red;">*</span><spring:message code="ftz.label.SETTLE_DAY1"/>：</td><!-- 交割日1 -->
				<td>
					<form:input path="ftzOffTxnDtl.tranDate" type="text" class="input-large date" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
				</td>
				
				<td class="label_td"><span style="color:red;">*</span><spring:message code="ftz.label.SETTLE_DAY2"/>：</td><!-- 交割日2 -->
				<td>
					<form:input path="ftzOffTxnDtl.expirationDate" type="text" class="input-large date" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
				</td>
			</tr>
			<tr>	
				<td class="label_td" colspan="2"><spring:message code="ftz.label.OPP_BANK_CODE"/>：<!-- 对方银行或机构代码 -->
				
					<form:input id="oppBankCode" path="ftzOffTxnDtl.institutionCode" type="text" class="input-large" onblur="clearName()"
...
<form:form id="form1" modelAttribute="FTZ210310Form">
