...
function authPass() {
	...
	form.action = "${pageContext.request.contextPath}/FTZ210311/AuthDtlDtlSubmit?authStat=1";
	form.submit();
}
...
function authRefuse() {
	...
	$("#sellRate").val($("#sellRate").val().replaceAll(",", ""));
	var form = document.getElementById("form");
	form.action = "${pageContext.request.contextPath}/FTZ210311/AuthDtlDtlSubmit?authStat=0";
	form.submit();
}
</script>
...
<!-- title -->
<div class="page_title"><spring:message code="ftzmis.title.210311.auth.txn"/></div>
<!-- body -->
<div class="row">
...
<div class="row">
	<div class="navbar navbar-fixed-bottom text-right" id="footer" style="text-align:center; margin-bottom:0px; line-height:30px; background-color: #eee; opacity:0.9;">
		...
		<input id="authRefuse" type="button" class="btn btn-primary" 
			onclick="authRefuse()" value="<spring:message code="ftz.label.UNAUTH" />">
