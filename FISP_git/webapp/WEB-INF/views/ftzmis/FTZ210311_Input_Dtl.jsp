<script type="text/javascript">
	$(function() {
		...
		if ("addMsg" == actionFlag) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210311/AddDtlSubmit";
		} else if ("updMsg" == actionFlag) {
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210311/UpdDtlSubmit";
		}
	...
	function delDetailDtl() {
		...
		if (null == selected_seqNo || "" == selected_seqNo) {
			...
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210311/InputDtlDel";
	...
	function addDetailDtl() {
		var selected_msgId = $("#msgId").val();
		showDialog('${pageContext.request.contextPath}/FTZ210311/AddDtlDtlInit?selected_msgId='
	...
	function updDetailDtl() {
		...
		if (null == selected_seqNo || "" == selected_seqNo) {
			...
			showDialog('${pageContext.request.contextPath}/FTZ210311/UpdDtlDtlInit?selected_msgId='
					+ selected_msgId + "&selected_seqNo="
					+ selected_seqNo,'550','1024');
			queryFTZ210311();
		}
	...
	function queryFTZ210311() {
		...
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210311/DtlInitReflash?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div class="page_title"><spring:message code="ftzmis.title.210311.input.msg" /><!-- 汇率掉期业务录入/修改 - 批量明细 --></div>
