<script type="text/javascript">
		...
		.bind(
				...
				function() {
					var selected_msgId = $(this).find("td:eq(3)")
							.text();
					showDialog('${pageContext.request.contextPath}/FTZ210311/QryDtl?selected_msgId='
	...
	function sbDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210311/SubmitDtl";
	...
	function delDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			if ("01" == selected_msgType || "04" == selected_msgType|| "02" == selected_msgType) {
				var form = document.getElementById("form");
				form.action = "${pageContext.request.contextPath}/FTZ210311/InputDel";
	...
	function addDetail() {
		showDialog('${pageContext.request.contextPath}/FTZ210311/AddDtlInit','500','1024');
		queryFTZ210311();
	}
	function updDetail() {
		var selected_msgId = $("#selected_msgId").val();
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			if ("01" == selected_msgType || "04" == selected_msgType|| "02" == selected_msgType) {
				showDialog('${pageContext.request.contextPath}/FTZ210311/UpdDtlInit?selected_msgId='
						+ selected_msgId,'500','1024');
				queryFTZ210311();
			} else {
	...
	function queryFTZ210311() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210311/AddQry";
		form.submit();
	}
</script>
...
<div class="page_title"><spring:message code="ftzmis.title.210311.input" /><!-- 汇率掉期业务录入/修改 --></div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210311/AddQry"
		...
		<table class="tbl_search">
			<tr>
				<td class="label_td"><spring:message code="ftz.label.BRANCH" /><!-- 机构 -->：</td>
			...
			<tr>	
				...
				<button type="button" class="btn btn-primary" id="qry" onclick="queryFTZ210311()">
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
							query="query_branchId=${FTZ210311Form.query_branchId}&query_submitDate_start=${FTZ210311Form.query_workDate_start}&query_submitDate_end=${FTZ210311Form.query_workDate_end}&query_msgId=${FTZ210311Form.query_msgId}&query_msgStatus=${FTZ210311Form.query_msgStatus}" action="/FTZ210311/AddQry"/></td>
					</tr>
				</table>
			</td>
		</tr>
