<script type="text/javascript">
	...
	function sbDtl() {
		...
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210401/AuthDtlSubmit";
		form.submit();
	}
...
<div class="page_title"><spring:message code="ftzmis.title.210401.auth.msg" /></div>
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td><t:moneyFormat type="text"
						value="${FTZ210401Form.ftzInMsgCtl.balance}"
