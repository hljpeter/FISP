<script type="text/javascript">
	...
	function addDetail() {
		...
		var input_Dtl_flag = $("#input_Dtl_flag").val();
		if ('add' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210401/AddDtlDtlSubmit";
		} else if ('upt' == input_Dtl_flag) {
			form.action = "${pageContext.request.contextPath}/FTZ210401/UptDtlDtlSubmit";
		}
		form.submit();
	}
	...
	function addRef() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210401/AddDtlDtlInit";
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210401.input.txn" />
</div>
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td><form:select path="ftzInTxnDtl.disitrictCode"
					...
					<input type="button" class="btn btn-small" onclick="queryRegion()" 
			...
			<tr>
				...
				<td><form:input id="termLength" path="ftzInTxnDtl.termLength" class=".input-large" 
						maxlength="4" onkeyup="numberFormat(this);" onbeforepaste="numberFormatCopy(this);"/></td>
			...
			<tr>
				...
				<td><form:input id="ftzInTxnDtl.valueDate"
						path="ftzInTxnDtl.valueDate"
						onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="input-large" /></td>
				<td class="label_td"><spring:message
...
<form:form id="form1" modelAttribute="FTZ210401Form" method="post">
