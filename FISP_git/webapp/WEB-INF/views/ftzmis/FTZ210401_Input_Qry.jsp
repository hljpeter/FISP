<script type="text/javascript">
	...
	function sbDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			form.action = "${pageContext.request.contextPath}/FTZ210401/SubmitDtl";
	...
	function delDetail() {
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			var form = document.getElementById("form");
			form.action = "${pageContext.request.contextPath}/FTZ210401/InputDel";
	...
	function addDetail() {
		showDialog('${pageContext.request.contextPath}/FTZ210401/AddDtlInit','500','1024');
		queryFTZ210401();
	}
	function uptDetail() {
		var selected_msgId = $("#selected_msgId").val();
		...
		if (null == selected_msgId || "" == selected_msgId) {
			...
			showDialog('${pageContext.request.contextPath}/FTZ210401/UptDtlInit?selected_msgId='
					+ selected_msgId,'500','1024');
			queryFTZ210401();
	...
	function queryFTZ210401() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/FTZ210401/AddQry?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div class="page_title">
	<spring:message code="ftzmis.title.210401.input" />
</div>

<div class="row">
	<form:form id="form"
		action="${pageContext.request.contextPath}/FTZ210401/AddQry"
				...
				<table>
					<tr>
						<td><util:pagination page="${page}"
								query="query_branchId=${FTZ210401Form.query_branchId}&query_submitDate_start=${FTZ210401Form.query_submitDate_start}&query_submitDate_end=${FTZ210401Form.query_submitDate_end}&query_msgId=${FTZ210401Form.query_msgId}&query_accountName=${FTZ210401Form.query_accountName}&query_accountNo=${FTZ210401Form.query_accountNo}&query_subAccountNo=${FTZ210401Form.query_subAccountNo}&query_msgStatus=${FTZ210401Form.query_msgStatus}"
								action="/FTZ210401/AddQry" /></td>
					</tr>
				</table>
			</td>
		</tr>
