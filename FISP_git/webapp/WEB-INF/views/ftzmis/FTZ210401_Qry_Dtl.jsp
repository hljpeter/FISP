<script type="text/javascript">
	...
	function queryFTZ210401Dtl() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210401/QryDtl?page.page="+${page.number+1};
		form.submit();
	}
</script>
...
<div class="page_title"><spring:message code="ftzmis.title.210401.query.msg" /></div>
	...
	<form:form id="form"
		...
		<table class="tbl_search">
			...
			<tr>
				...
				<td><form:select path="ftzInMsgCtl.balanceCode" disabled="true">
						<form:option value=""></form:option>
