<script type="text/javascript">
	$(function(){
		...
		$("#pageTable").find("tr").bind('dblclick', function() {
			...
			window
			.showModalDialog(
					'${pageContext.request.contextPath}/FTZ210501/AuthDtl?selected_actNo='
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/FTZ210501/AuthQry";
		form.submit();
	}
...
<div class="page_title" align="center">
	<spring:message code="ftzmis.title.210501.auth"/>
</div>
