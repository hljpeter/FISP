<script type="text/javascript">
	function checkBalance(){		
		...
		showDialog(
				'${pageContext.request.contextPath}/FTZINCOM/BalanceCheckRe?check_AccountNo='
...
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/FTZ210501/Insert" 
		...
		<form:hidden path="ftzActMstr.accStatus" id="accStatus" />
		<table class="tbl_search">
			...
			<tr>
				...
				<td>
					<form:input id="subAccountNo" path="ftzActMstr.subAccountNo"  class=".input-large" readonly="true"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3">
					<form:select path="ftzActMstr.accStatus" id="accStatus" disabled="true">
						<option value=""></option>
			...
			<tr>
				...
				<td><form:input id="submitDate"
						path="ftzActMstr.submitDate" 
...
<div class="row" style="margin-bottom: 40px;">
	<div class="navbar navbar-fixed-bottom text-center" id="footer"
		...
		<button name="btn" class="btn btn-primary" onclick="checkBalance();">
		<spring:message code="ftz.label.newValidation"/></button>
