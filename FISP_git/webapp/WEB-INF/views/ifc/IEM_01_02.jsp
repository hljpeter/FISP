...
function searchParam(mid) {
	var form = document.getElementById("form");
	form.action = '${pageContext.request.contextPath}/iem01/02/param?mid='+mid+'&alternative='+1+'&impfileIdValue='+impFileIdValue;
	form.target="curWindow";
	form.submit();
}
...
function getValue() {
	...
	form.action = "${pageContext.request.contextPath}/iem01/03/value?impfileIdValue="+impFileIdValue;
	form.target="curWindow";
	form.submit();
}
...
function getLSValue() {
	var form = document.getElementById("form1");
	form.action = "${pageContext.request.contextPath}/iem01/04/staticparam?impfileIdValue="+impFileIdValue;
	form.target="curWindow";
	form.submit();
}
									...
									<div class="tbl_page_head">
										<table
											...
											<thead>
												...
												<th class="tbl_page_th" width="120px" style="display:none;"><spring:message code="iem.label.TYPE"/></th>
												<th class="tbl_page_th" width="120px"><spring:message code="file.table"/></th>
												</tr>
											</thead>
										</table>
									</div>
												...
												<c:forEach var="dto" items="${fileFieldList}" varStatus="i">
													<tr>
													    ...
													    <td class="tbl_page_td_left vtip" width="120px" style="display:none;">java.lang.String</td>
													      <td class="tbl_page_td_left vtip" width="120px" style="display:none;">java.lang.String</td>
														<td class="tbl_page_td_left vtip" width="120px">${dto.fieldName}</td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
