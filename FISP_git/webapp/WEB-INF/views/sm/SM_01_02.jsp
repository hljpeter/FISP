<script type="text/javascript">
	...
	function addGo() {
		...
		form.action = "${pageContext.request.contextPath}/sm01/02/init";
		form.submit();
	}
	...
	function add() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/sm01/02/add";
	...
	function bankSearch() {
		var jstr = window.showModalDialog('${pageContext.request.contextPath}/cu03/04/init', window, 'dialogHeight:500px; dialogWidth: 1000px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
		if (jstr!=null)
...
<!-- title -->
<div class="page_title"><spring:message code="index.label.sm.OrganizationMaintenanceAdd"/></div>

<!-- body -->

<div class="row" style="margin-bottom: 20px;">
	<form:form id="form" action="${pageContext.request.contextPath}/sm01/02/init" method="post"  modelAttribute="orgInfTmpForm" class="form-horizontal">
		<table class="tbl_search">
	    	<tr>
				<td width="25%" class="label_td"><font color="red">*</font><spring:message code="index.label.sm.OrganizationId"/></td>
				<td width="75%" >
					<form:input id="orgid" path="orgid" type="text" class=".input-small" maxlength="20" onkeyup="numberStringFormat(this);" onbeforepaste="numberStringFormatCopy(this);"  />
				</td>
			</tr>
			<tr>
				<td class="label_td">
				...
				<td>
					<form:input id="orgname" path="orgname" type="text" class="span8" maxlength="60"/>
				</td>
			<tr>
			<tr>
				<td class="label_td"><spring:message code="index.label.sm.SuperiorOrganizationId"/></td>
				<td>
					<form:input id="suprorgid" path="suprorgid" type="text" class=".input-small" maxlength="20" onkeyup="numberStringFormat(this);" onbeforepaste="numberStringFormatCopy(this);" onblur="setUpSuprOrgInf()"/> <input
			...
			<tr>
				...
				<td>
					<form:input id="suprorgname" path="orgInfTmp.suprorgname" type="text" class="span8" maxlength="60" readonly="true"/>
				</td>
			<tr>
			<!-- close by wy 2013-12-05
			<tr>
			...
			<tr>
				...
				<td>
					<form:input id="bankname" path="orgInfTmp.bankname" type="text" class="span8" maxlength="60"  readonly="true"/>
				</td>
			<tr>
			 -->
...
<div class="row">
	<div class="navbar navbar-fixed-bottom text-right" id="footer" style="margin-bottom:0px; line-height:30px; background-color: #eee; opacity:0.9;">
		<button id="addMoreBtn" type="button" class="btn btn-primary" onclick="addGo()"><spring:message code="button.lable.AddMore"/></button>
