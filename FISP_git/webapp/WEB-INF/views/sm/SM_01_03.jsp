<script type="text/javascript">
	...
	function modify() {
		...
		form.action = "${pageContext.request.contextPath}/sm01/03/modify";
...
<div class="row" style="margin-bottom: 20px;">
	<form:form id="form" action="${pageContext.request.contextPath}/sm01/03/init" method="post" modelAttribute="orgInfForm" class="form-horizontal">
