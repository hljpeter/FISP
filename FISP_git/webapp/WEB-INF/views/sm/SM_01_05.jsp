...
<div class="row" style="margin-bottom: 40px;">
	<form:form id="form_01DetailSearch" action="${pageContext.request.contextPath}/sm01/05/detailSearch_01" method="post" modelAttribute="orgInfForm" class="form-horizontal">
