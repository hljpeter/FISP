<script type="text/javascript">
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/sm03/07/search";
		form.submit();
	}
	//detail button
...
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/sm03/07/init" method="post" modelAttribute="userInfForm" class="form-horizontal">
