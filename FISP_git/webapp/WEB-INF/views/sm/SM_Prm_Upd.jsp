<script type="text/javascript">
	...
	function update() {
		...
		form.action = "${pageContext.request.contextPath}/SM_Prm_Upd/Update";
...
<!-- title -->
<div class="page_title"><spring:message code="fisp.title.sysParam.update"/></div>
	...
	<form:form id="form" action="${pageContext.request.contextPath}/" method="post" modelAttribute="SM_Prm_QryForm" class="form-horizontal">
		<table class="tbl_search">
	    	<tr>
				...
				<td>
					<form:input id="paramGroup" path="sysParam.paramGroup" type="text" class=".input-small" readonly="true" maxlength="20"/>
				</td>
				<td class="label_td">
				<spring:message code="fisp.label.sysParam.code"/>
				</td>
				<td>
					<form:input id="paramCode" path="sysParam.paramCode" type="text" class=".input-small" readonly="true" maxlength="20"/>
				</td>
			<tr>
			<tr>
...
<div class="row">
	<div class="navbar navbar-fixed-bottom text-right" id="footer" style="margin-bottom:0px; line-height:30px; background-color: #eee; opacity:0.9;">
		<input id="confirmBtn" type="button" class="btn btn-primary" onclick="update()" value="<spring:message code="button.lable.Submit"/>">
