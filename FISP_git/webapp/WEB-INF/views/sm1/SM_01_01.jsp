...
<script type="text/javascript">
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/nsm01/01/search";
		form.submit();
	}
	//add button
	function add() {
		window.showModalDialog('${pageContext.request.contextPath}/nsm01/02/init', window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
	}
	//modify button
	function modify(orgid) {
		document.getElementById("orgInfOrgid").value = orgid;
		window.showModalDialog('${pageContext.request.contextPath}/nsm01/03/search?orgInf.orgid='+orgid, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
		search();
	}
	//del button
	function del(orgid) {
		...
		form.action = "${pageContext.request.contextPath}/nsm01/01/del";
...
<div class="pagination pull-right" style="margin-top: 5px; margin-bottom: 0px;">
	<div class="leftPage">
		<util:pagination action="/nsm01/01/search" page="${page}" query="orgid=${orgInfForm.orgid}&orgname=${orgInfForm.orgname}" />
	</div>
</div>
