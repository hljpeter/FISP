<script type="text/javascript">
	...
	function addGo() {
		...
		form.action = "${pageContext.request.contextPath}/nsm01/02/init";
		form.submit();
	}
	...
	function add() {
		var form = document.getElementById("form");
		form.action = "${pageContext.request.contextPath}/nsm01/02/add";
...
<div class="row" style="margin-bottom: 20px;">
	<form:form id="form" action="${pageContext.request.contextPath}/nsm01/02/init" method="post"  modelAttribute="orgInfTmpForm" class="form-horizontal">
	 <form:hidden path="orgInfTmp.suprorgname" />
