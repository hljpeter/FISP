<script type="text/javascript">
	...
	function search() {
		...
		form.action = "${pageContext.request.contextPath}/nsm01/04/search";
		form.submit();
	}
	...
	function detailSearch(id) {
		...
		window.showModalDialog('${pageContext.request.contextPath}/nsm01/05/detailSearch_04?orgInfTmp.id='+id, window, 'dialogHeight:500px; dialogWidth: 1024px;edge: Raised; center: Yes; help: no; resizable: Yes; status: no;');
...
<!-- body -->
<div class="row">
	<form:form id="form" action="${pageContext.request.contextPath}/nsm01/04/init" method="post" modelAttribute="orgInfTmpForm" class="form-horizontal">
