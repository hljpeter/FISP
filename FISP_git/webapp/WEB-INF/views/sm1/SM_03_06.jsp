...
<script type="text/javascript">
	...
	function auth() {
		...
		form.action = "${pageContext.request.contextPath}/nsm03/06/auth";
	...
	function reject() {
		var form = document.getElementById("form_04DetailSearch");
		form.action = "${pageContext.request.contextPath}/nsm03/06/reject";
...
<div class="row" style="margin-bottom: 40px;">
	<form:form id="form_04DetailSearch" action="${pageContext.request.contextPath}/nsm03/05/detailSearch_04" method="post" modelAttribute="userInfTmpForm" class="form-horizontal">
