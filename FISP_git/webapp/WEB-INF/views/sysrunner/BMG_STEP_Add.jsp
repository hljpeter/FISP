<script type="text/javascript">
	...
	$(function() {
		...
		if (msg && msg == "SUCCESS") {
			...
			$("#stepStartType").attr("disabled", "disabled");
			$("#stepStartDay").attr("disabled", "disabled");
			$("#subStepNum").attr("disabled", "disabled");
			$("#stepCommand").attr("disabled", "disabled");
			$("#stepEnable").attr("disabled", "disabled");
			$("#allowSkip").attr("disabled", "disabled");
			$("#priority").attr("disabled", "disabled");
			$("#autoSkip").attr("disabled", "disabled");
			$("#unDependencyStepList").attr("disabled", "disabled");
			$("#dependencyStepList").attr("disabled", "disabled");
			$("#unExcludeStepList").attr("disabled", "disabled");
			$("#excludeStepList").attr("disabled", "disabled");
	...
	function addExclStep() {
		$("#excludeStepList").append(
				$("#unExcludeStepList option:selected"));
	}
	// 移除
	function delExclStep() {
		$("#unExcludeStepList").append(
				$("#excludeStepList option:selected"));
	}
	...
	function createStep() {
		...
		form.action = "${pageContext.request.contextPath}/BMG_STEP_Add/SubmitStep";
...
<div class="page_title">
	<spring:message code="sysrunner.title.BatchManageStepAdd" />
</div>
	...
	<form:form id="form"
		...
		<table class="tbl_search">
			<tr>
				...
				<spring:message code="sysrunner.label.TaskName" /></td>
				<td><form:input id="taskName" path="batStepInfo.taskName"
						class=".input-large" readonly="true" /></td>
				<td class="label_td"><font color="red">*</font>
				<spring:message code="sysrunner.label.StepName" /></td>
				<td><form:input id="stepName" path="batStepInfo.stepName"
						class=".input-large" /></td>
			</tr>
			<tr>
				<td class="label_td"><font color="red">*</font>
				<spring:message code="sysrunner.label.StepType" /></td>
			...
			<tr>
				<td class="label_td">&nbsp&nbsp&nbsp
				<spring:message code="sysrunner.label.StepSubNumber" /></td>
				<td><form:input id="subStepNum" path="batStepInfo.subStepNum"
						class=".input-large" /></td>
				<td class="label_td">&nbsp&nbsp&nbsp
				<spring:message code="sysrunner.label.StepPriority" /></td>
				<td><form:input id="priority" path="batStepInfo.priority"
						class=".input-large" /></td>
			</tr>
			<tr>
				<td class="label_td"><font color="red">*</font>
				<spring:message code="sysrunner.label.StepEnable" /></td>
				<td><form:select id="stepEnable" path="batStepInfo.stepEnable">
						<form:option value=""></form:option>
						<form:options items="${BMG_FLAG}" />
					</form:select></td>
				<td class="label_td"><font color="red">*</font>
				<spring:message code="sysrunner.label.StepSkip" /></td>
			...
			<tr>
				<td class="label_td"><font color="red">*</font><spring:message code="sysrunner.label.StepCommand" /></td>
				<td colspan="3"><form:input id="stepCommand" path="batStepInfo.stepCommand"
						class="input-xxlarge" /></td>
			</tr>
			
			<tr>
				<td class="label_td"><font color="red">*</font><spring:message code="sysrunner.label.StepAutoSkip" /></td>
				<td colspan="3"><form:select id="autoSkip" path="batStepInfo.autoSkip">
						<form:option value=""></form:option>
						<form:options items="${BMG_FLAG}" />
					</form:select></td>
			</tr>
			...
			<tr>
				...
				<td><form:input id="dpCfgId" path="batStepInfo.dpCfgId"
						...
						path="batStepInfo.dpCfgName" class=".input-large" readonly="true" /> <input
					type="button" class="btn btn-small" onclick="queryCfg()"
							...
							<td align="left">
								<fieldset style="width: 98%; padding: 2px;">
									<table>
										...
										<tr>
											<td><select multiple="multiple"
												name="unExcludeStepList" id="unExcludeStepList"
												style="width: 250px; margin: 2px;">
													<c:forEach var="dto"
											...
											<td><select multiple="multiple"
												name="excludeStepList" id="excludeStepList"
												style="width: 250px; margin: 2px;">
													<c:forEach var="dto2"
